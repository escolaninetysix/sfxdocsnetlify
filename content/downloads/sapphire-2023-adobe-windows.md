{
  ...
  "download_url": "https://cdn.borisfx.com/borisfx/store/sapphire-adobe/sapphire-ae-install-2023.01.exe",
  "host": "Adobe",
  ...
  "require_login": true,
  "title": "Sapphire 2023 for Adobe After Effects, Premiere Pro Windows",
...
* Windows AE: Prevented a hang that could occur during multi-frame render.

* AE: PrismLens: Fixed a CUDA memory issue that could occur when applied to a text layer.
