{
   ...
   "title": "Mocha Pro 2019 - Release Notes"
}
...
This is a new version containing many new features and defect fixes.
Release notes cover Mocha Pro, for both standalone and plugin versions of the product.
...
icon:exclamation-triangle[] OFX builds of the Mocha Pro Plugin have been tested to work with The Foundry Nuke, Blackmagic Fusion Studio, HitFilm Pro, Vegas Pro and Silhouette v6. +

icon:exclamation-triangle[] Other hosts that utilize OFX may operate the Mocha Pro OFX Plugin correctly, but at this stage they are unofficially supported and may experience problems.

icon:exclamation-triangle[] Version {revision} may not be backwards compatible with earlier versions of Mocha.

Python is not supported in the plugin versions of *Mocha Pro*. This means any tools created by Python will not be functional. This includes some exports such as Silhouette shapes.
...
== Fixed issues since 5.6.0


[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9293 Zoom window is shown for "Next Keyframe" when there is no next keyframe
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The Zoom window no longer appears when there isn't a following keyframe.
|===
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9250 Render licenses hang Python when ISL_PRODUCT = "mochaVR"
| *Platform:* | All Platforms
| *Product:* | Mocha VR
| *Bug Description:* | This was made obsolete as we no longer require the ISL_PRODUCT variable to be set. Mocha VR standalone is no longer a separate product.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9172 Crash during tracking when the layer in/out points are not a multiple of 5 and tracking data already exists outside of the layer range
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | There is no longer a crash when tracking data already exists outside the layer range.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9170 Mocha Python parameter().set() does not work
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha Python parameter().set() now works as expected.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9139 After Effects crashes when reopening Mocha after trying to export rendered clip
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | AE no longer crashes when reopening the Mocha GUI
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9049 "Bad argument" error in Mocha with some footage in Nuke
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plugin
| *Bug Description:* | You no longer get a "Bad argument" error in Mocha with some footage in Nuke
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9046 Copy and pasting a layer in a group does not paste the copy in to the same group
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Copy and pasting a layer in a group now pastes the copy in to the same group
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9018 A background layer with multiple contours may not use the track mattes of its foreground layers
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mattes with any number of contours now track correctly with foreground occlusion mattes.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9008 For unlicensed Mocha plugin, clicking "Reset" in AE's UI generates "No interactive license in use" message.
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Clicking 'Reset' on the Mocha Pro effect no longer creates an unlicensed state.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8987 Crash upon the second attempt to Export Lens Data
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Lens data now exports every time.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8962 Undo returns "Incorrect tool value, or tool not yet handled" after switching Tool Set
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Undo no longer returns errors when switching tools.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8949 Reset button doesn't reset Mocha project in Mocha plug-ins
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Reset button now clears the Mocha project file.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8928 AdjustTrack keyframes are not visible when clicking on adjustment buttons
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | AdjustTrack keyframes are now visible when interacting with buttons.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8687 Mocha icons ignore screen resolution change when rescaling interface
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha now adapts to the right screen resolution change.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8657 Mocha slows down Nuke even when not rendering
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha now correctly passes through when not in use.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8607 Tool Tooltip is cropped on Windows
| *Platform:* | Windows
| *Product:* | All Products
| *Bug Description:* | Tool tips are no longer cropped on Windows
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8497 Mocha gives “invalid canvas height” message on launch then works correctly
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | There is no longer an error on starting the GUI.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-5439 Mocha Adobe Plugin reads clip frame instead of comp frame when working with trimmed layers
| *Platform:* | Windows and macOS
| *Product:* | Mocha Pro Adobe Plugin
| *Bug Description:* | Mocha Adobe Plugin now reads comp frame when working with trimmed layers
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The Zoom window can no longer interfere with the canvas when turned off.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The white transform bounding box will start to appear as soon as you draw a shape.
| *Workaround:* | None. You can turn off the transform tool if you wish to hide it.
|===
...
| *Platform:* | Windows
| *Product:* | Mocha Pro OFX Plugin
| *Bug Description:* | Some clips can crash Vegas when opened in the Mocha GUI.
| *Workaround:* | Convert clip to another format.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | In some 360 stereo Remove projects using clean plates, a small black artefact can appear at the seam when rendering using the GPU
| *Workaround:* | Use CPU rendering.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Magnetic shape dots can look very small on high resolution screens
| *Workaround:* | Work at a lower resolution.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Distortion maps can cause a crash if using GPU tracking.
| *Workaround:* | Use CPU tracking with Distortion maps.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | If you switch from a clean plate clip to "None" in the clean plate drop down, the "Use clean plates exclusively" option becomes unusable.
| *Workaround:* | Create a new clean plate and the option reenables.
|===
...
| *Bug Description:* | Calling methods from mocha.ui in Python can cause a crash.
| *Workaround:* | Avoid mocha.ui methods.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Dragging the Mocha window from a retina to a nn-retina screen can cause the image to crop when zooming
| *Workaround:* | Resize the window. Everything should snap back into place.
|===
...
| *Platform:* | macOS
| *Product:* | Mocha Pro OFX Plugin
| *Bug Description:* | Resolve currently crashes when adding the Mocha Pro plugin.
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Dragging toolbars over to the right of the default layout will cause the interface to jump when the progress bar animates.
| *Workaround:* | None.
|===
...
| *Platform:* | macOS
| *Product:* | Mocha Pro AVX Plugin
| *Bug Description:* | Avid will crash using the mocha plugin on OSX 10.11
...
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Plugin
| *Bug Description:* | There can be a white screen before the full interface loads in the Mocha plugin
| *Workaround:* | None.
|===
...
== Software Requirements for Mocha Pro Plugins
