...
This is a new release with several new features and defect fixes.
...
== Fixed issues since Mocha Pro 2020.5 v7.5.1

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10006 GPU Module error and occasional crash opening Mocha GUI on some systems
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Recent system driver updates could cause a buffer issue and prohibited GPU support. Sometimes this would also result in a crash when trying to open the Mocha GUI.
|===
...
| *Bug Description:* | Wacom assignments are now recognised when used in the plugin
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Using the mouse and then using a Wacom tablet could cause a large lag in the cursor.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10763 Mocha Pro Crashes on Node Creation in Nuke 12.2 on Linux
| *Platform:* | Linux
| *Product:* | MOcha Pro OFX Plug-In
| *Bug Description:* | Mocha Pro could crash as soon as you created a node in Nuke 12.2.
|===
...
| *Bug Description:* | If you trim a composition to a non-zero start frame, the Mocha GUI will set a frame offset at the same number.
| *Workaround:* | Set your composition frame start to zero.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | If you duplicate a layer, the tracked mesh does not duplicate with it.
| *Workaround:* | Track the mesh separately on the duplicated layer.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Opacity changes don't preview in Insert.
| *Workaround:* | Render the insert to see the opacity.
|===
...
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-In
| *Bug Description:* | The first frame of tracking data is missing when pasting data to Silhouette.
| *Workaround:* | None.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Some insert renders can show a white edge with alpha.
| *Workaround:* | None.
|===
...
| *Platform:* | Linux
| *Product:* | Mocha Pro OFX Plug-In
| *Bug Description:* | Mocha Pro crashes as soon as you create a node in Nuke 12.2, due to missing symbol uuid_generate.
| *Workaround:* | When running Nuke, use the LD_PRELOAD environment variable to add libuuid. For example:
`LD_PRELOAD=/usr/lib64/libuuid.so.1 ./Nuke12.2`
|===
...
| *Bug Description:* | If a large amount of the thitd-party scripts are displayed in the AE panels, the Mocha GUI can slow down.
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Flame GMask Tracer Shapes are offset incorrectly compared to the axis transform.
| *Workaround:* | Offset the shape keyframes manually.
|===
...
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Mocha’s colourspace controls behave inconsistently when the Mocha UI is opened from Silhouette, and the image is shown in the wrong colourspace.
| *Workaround:* | None.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | After activating with a mocha subscription license, the welcome screen will still say Activate instead of Deactivate.
| *Workaround:* | Click Activate and the the license tool will ask you to deactivate.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10665	Layer splines do not follow stabilize preview
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Layer splines do not warp with the stabilize preview
| *Workaround:* | None.
|===
