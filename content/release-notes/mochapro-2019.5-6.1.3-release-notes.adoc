{
   "date": "2019-11-27T00:04:00-00:00",
   "description": "Mocha Pro 2019.5 (6.1.3) release notes",
   "excerpt": "This is a minor maintenance release containing several defect fixes. Release notes cover Mocha Pro, for both standalone and Plug-in versions of the product.",
   "image_url": "",
   "tags": [
      "Mocha"
   ],
   "title": "Mocha Pro 2019.5 v6.1.3 - Release Notes"
}
= Mocha(R) Pro 2019.5 v6.1.3 Release Notes

:Author:    (C) Boris FX/Imagineer Systems Ltd.
:Email:     support@borisfx.com
:Date:      27/11/2019
:Revision:  2019.5 v6.1.3
:icons: font
...
This is a minor maintenance release to correct some defects.
...
WARNING: The Mocha Pro 2019.5 AVX Plugin requires macOS 10.12 or higher if you are running Media Composer on Mac.
...
== New features in Mocha Pro 2019.5 v6.1.3
There are no new features in v6.1.3. This is a maintenance update only.

== New features in Mocha Pro 2019.5 v6.1.2
* *HASP Dongle support:* Mocha now supports HASP HL dongles for node-locked licenses
* *Memory Management Improvements:* The Mocha plugin now releases more memory when it fails to get an image from the host due to high memory pressure
...
== Fixed issues since Mocha Pro 2019 6.1.2
...
| *Bug Description:* | Offsets are no longer incorrect for Mocha v6.1.1 projects opened inside Nuke.
|===
...
| *Bug Description:* | Mocha Pro could become unlicensed if used intermittently in a long host project timeline.
|===
...
| *Bug Description:* | Motion Blur now renders in left and right matte views correctly for stereo.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10117	Mocha can crash host when manually checking for software updates
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha could crash when checking for software updates via the manual button in preferences.
|===
...
* *Mocha Plug-in for OFX:* Autodesk Flame 2020. The Foundry Nuke 8 to Nuke 12. Fusion Studio 8 to 16. HitFilm Pro 2017 or higher. Silhouette 6 to 7. Vegas Pro 14 to 16.

NOTE: While Mocha will work in Resolve 16, currently we do not officially support Resolve in this release.
