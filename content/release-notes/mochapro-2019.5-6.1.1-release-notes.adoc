{
   ...
   "description": "Mocha Pro 2019.5 (6.1.1) release notes",
   ...
   "title": "Mocha Pro 2019.5 v6.1.1 - Release Notes"
}
= Mocha(R) Pro 2019.5 v6.1.1 Release Notes

:Author:    (C) Boris FX/Imagineer Systems Ltd.
:Email:     support@borisfx.com
:Date:      24/06/2019
:Revision:  2019.5 v6.1.1
:icons: font
...
This is a minor maintenance release containing several defect fixes.
...
== Fixed issues since Mocha Pro 2019 6.1.0

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10004 Mocha BFX license tool asks for activation code when trying to deactivate some licenses
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Some licenses would not deactivate correctly.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10000 Bundle License Activation Doesn't Work
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Activating a bundle license now works correctly
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9998 Crash in OFX hosts when visible layers dialog is opened twice
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plugin-In
| *Bug Description:* | Hosts no longer crash if you open the Visible layers dialog twice on an empty project.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9996 The Hold Zoom Tool (Z) stays in zoom mode with the Magnetic Shape Tool and Rectangle/Circle Shape Tools
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Zoom could get stuck when switching tools and toggling Zoom.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9990 Users would like CC Power Pin with all keyframes on the effect
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The CC Power Pin export now has all keyframes on the corner pin effect and non in the layer tranform, rotation and scale.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9987 Flame 2020 on Linux crashes when clicking on Batch if Remove module is turned on
| *Platform:* | Linux
| *Product:* | Mocha Pro OFX Plug-In
| *Bug Description:* | Flame no longer crashes when opening a batch with Mocha remove render turned on.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9976 Crash when invoking the edge snap tool
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Edge Snap could crash the program when too many smoothed points were selected.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9944 Flame crashes on launch when trying to load the workspace if Mocha doesn't disable offscreen buffers
| *Platform:* | macOS and Linux
| *Product:* | Mocha Pro OFX Plug-In
| *Bug Description:* | Flame could crash if offscreen buffers were enabled.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9673 Detail field for magnetic/freehand shape is disabled until layer is re-selected
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The detail field for Magnetic and Freehand tools was disabled.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Pressing delete while you have a layer selected no longer clears the undo stack
|===
