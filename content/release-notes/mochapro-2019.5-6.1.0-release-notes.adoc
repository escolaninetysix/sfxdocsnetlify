{
   ...
   "description": "Mocha Pro 2019.5 (6.1.0) release notes",
   "excerpt": "This is a major point release containing several new features and defect fixes. Release notes cover Mocha Pro, for both standalone and Plug-in versions of the product.",
   "image_url": "",
   "tags": [
      "Mocha"
   ],
   "title": "Mocha Pro 2019.5 v6.1.0 - Release Notes"
}
= Mocha(R) Pro 2019.5 v6.1.0 Release Notes

:Author:    (C) Boris FX/Imagineer Systems Ltd.
:Email:     support@borisfx.com
:Date:      05/06/2019
:Revision:  2019.5 v6.1.0
:icons: font
...
This is a major point release containing several new features and defect fixes.
...
While Mocha will work in the Blackmagic Resolve 16 Beta, we currently do not officially support Resolve 16 in this release.
...
icon:exclamation-triangle[] The Mocha Pro 2019.5 AVX Plugin requires macOS 10.12 or higher if you are running Media Composer on Mac.
...
== Fixed issues since Mocha Pro 2019 6.0.3

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9949 Undo does not remove a keyframe created upon moving the shape
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Keyframes are now removed correctly when undoing a transform.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9929 Foreground Mattes are not occluding correctly in GPU processing with 16-bit or float footage
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | GPU tracking now deals with foreground mattes in high bit depth footage correctly.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9909 Fusion crashing on Linux when Mocha OFX is installed
| *Platform:* | Linux
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Fusion on Linux no longer crashes with the OFX plugin installed.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9906 Remove Illumination modelling with foreground elements causes unfilled areas
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Remove now stops creating blank fills when it doesn't have available lighting data to work with.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9891 Remove with two layers is not correctly removing second layer
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Multiple-layer removes now remove correctly.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9889 "Use cleanplates exclusively" is not set correctly when the clean plate clip is switched to None then back again.
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The "Use cleanplates exclusively" option now always sets correctly.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9871 Stabilize render causes Standard Library Error when first trying to render
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Stabilize render would cause an error if a Stabilize clip didn't already exist.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9847 Sporadic crashes when opening Mocha GUI in Fusion Studio
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Fixed sporadic crashes in Fusion when opening the Mocha GUI.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9844 GPU Tracking is drifting for 360 across seam
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Fixed a black line at the stitch in the warped image that caused tracking drift in 360 footage.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Reorient now uses AdjustTrack modified data
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Undoing keyframe deletion now restores the keyframe correctly.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9832 Host crash when importing matte clip to stereo 360 Mocha project
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Matte clips now properly import into stereo 360 projects.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9823 Tracked stereo offset only works for "All views" tracked frames in Mocha
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | You can now track one frame in stereo and have the offset carry through for a single eye track.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The fine-tuning shortcut now works for surface corners.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | X-Splines with apparently straight lines no longer generate curves in exports when they are converted to Bezier.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9646 Mocha slows down if a project has a layer with large numbers of points in it
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Fixed slow down of viewport when a project has very point-heavy splines selected.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Rotating selected Bezier shape points no longer cause the shape to be distorted incorrectly.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8425 Fusion doesn't load proxy into Mocha GUI
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Proxies now load into the Mocha GUI in Fusion.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Some AE bezier masks now longer have unexpected curves when exporting from an x-spline layer
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8522 "Undo" has no effect on Tracking in Mocha VR/Pro OFX on macOS
| *Platform:* | MacOS
| *Product:* | Mocha Pro OFX Plug-in, Mocha VR OFX Plug-in
...
* *Mocha Plug-in for OFX:* Autodesk Flame 2020 or higher. The Foundry Nuke 8 or higher. Fusion Studio 8 or higher. HitFilm Pro 2017 or higher. Silhouette 6 or higher.

NOTE: While Mocha will work in the Resolve 16 Beta, currently we do not officially support Resolve in this release.
