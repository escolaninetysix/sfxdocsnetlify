{
  "title": "Sapphire 2022.04 release notes",
...
### What’s New in Sapphire 2022.04

* Improve License Behavior: Fixed an issue where the Flare Designer might checkout a different Sapphire license than the Sapphire Plug-ins.

* Flare Designer and Effect Builder: Fixed a sporadic crash when the Flare Designer or Effect Builder were kept open for long periods of time.

* LensFlare: Fixed a sporadic crash when using Shadows with Elements in Lens Flares.

* CUDA: Improve stability when Sapphire falls back from CUDA to the GPU.

* Windows: Fixed a crash on Windows when using the crop parameters.

* Resolve: Fixed an issue that prevented Mocha from launching.
