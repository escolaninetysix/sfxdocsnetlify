...
This is a maintenance release with several new features, performance improvements and defect fixes.
...
WARNING: Mocha Pro 2021 requires macOS 10.12 or higher, but we recommend at least macOS 10.13 for GPU support.

== New features in Mocha Pro 2021 v8.0.1
...
* *Mesh regeneration warnings:* Mocha now shows a warning message box if regeneration of mesh will destroy existing mesh tracking keys
...
** For more information on using the PowerMesh feature, see the PowerMesh section of the Tracking Basics chapter in the User Guide.
* *PowerMesh Export to After Effects Nulls:* You can export PowerMesh tracks to After Effects nulls via the plug-in interface. See 'Creating PowerMesh Nulls' in the Plug-In section of the User Guide.
* *PowerMesh Export to Alembic:* You can export tracks to a Alembic Mesh with a camera based on the PowerMesh tracking. See the User Guide section on 'Exporting to Alembic' for more details on how to use the format.
...
** See the Warp Mapping section of the stabilize module in the User Guide for more details.
* *AdjustTrack V2:* We’ve completely overhauled AdjustTrack to be easier to use and less prone to errors. For more information on using AdjustTrack V2, see the AdjustTrack Module chapter in the User Guide.
...
== Fixed issues since Mocha Pro 2020.5 v8.0.0

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10984 Mesh Tracking is not undoable
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mesh tracking is now undoable.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10979 Cannot bring Mocha in front of Avid
| *Platform:* | macOS
| *Product:* | Mocha AVX Plug-in
| *Bug Description:* | On Mac you could not remove some Avid windows from the foreground of the Mocha UI.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10963 Colorspace is wrong for sRGB sources in Mocha OFX plug-in when launched from Silhouette
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-In
| *Bug Description:* | Color is no longer washed out for sRGB sources in Mocha OFX for Silhouette.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10962 Mocha OFX Plug-in Frame Range Off By -1
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-In
| *Bug Description:* | Frame offsets were out by one for some OFX host projects.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10961 License tool returns an error about wrong hosts when attempting to license within Mocha hosts
| *Platform:* | All Platforms
| *Product:* | All Mocha Pro Plug-Ins
| *Bug Description:* | Activating within the Mocha Pro plug-in would cause an error saying the user had the wrong host.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10959 Closing Mocha GUI before project opens hangs mochaui
| *Platform:* | All Platforms
| *Product:* | All Mocha Pro Plug-Ins
| *Bug Description:* | Closing the Mocha Pro GUI too quickly after opening it could cause a hang.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10950 Alembic reference frame range is unconstrained
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The reference frame for Alembic exports was not limited to the frame range.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10947 GStreamer export: unable to export the second time
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Standalone
| *Bug Description:* | Attempting to export renders twice from the GStreamer export dialog caused a crash.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10945 GStreamer writing is unable to quit Mocha cleanly after discarding Render Export GUI
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Cancelling a rendered clip export to movie would cause a hang in Mocha.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10944 Mocha software update mentions a newer version of the current version is available
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Software update would incorrectly show a major version as a minor version update.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10943 The clip start offset frame is not picked up going between Silhouette and Mocha Pro
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-In
| *Bug Description:* | The correct starting frame offset was not used in the Mocha Pro OFX plugin for Silhouette.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10905 Frame offset is read incorrectly for trimmed After Effects compositions
| *Platform:* | Windows and macOS
| *Product:* | Mocha Pro Adobe Plug-In
| *Bug Description:* | If you trimmed a composition to a non-zero start frame, the Mocha GUI would double the frame offset display number.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10890 Duplicating a layer with a tracked mesh does not duplicate the mesh
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | If you duplicate a layer, the tracked mesh now duplicates with it.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10876 Opacity in Insert is no longer showing in preview
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Opacity changes now preview in Insert.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10838 Tracking data pasted from Mocha to Silhouette is missing the first frame
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-In
| *Bug Description:* | The first frame of tracking data was missing when pasting data to Silhouette.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10821 Adobe plugin PowerMesh "Create nulls" cannot be undone in one pass
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | You can now undo creation of PowerMesh nulls with one step.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10805 Rendering an Insert with an RGBA Insert Images produces white lines at the edges of the inserted image
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Insert renders no longer show a white edge with alpha if "premultiply" is turned on in the insert clip options
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10746 Mocha crashes when Mesh is turned on while Mocha Pro is connected to a colorbar node in Nuke
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha no longer crashes when Mesh is turned on while Mocha Pro is connected to a colorbar node in Nuke
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10704	Keyframed shapes in Flame GMask Tracer Shape+Axis export are off by one
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Flame GMask Tracer Shapes are now keyframed correctly.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10696	Colour Difference between Silhouette and Mocha using Cineon Files
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Added support for Silhouette proprietary OFX OCIO Display and Display View properties
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10682	Welcome Screen not listing Deactivate while using a subscription license
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Welcome Screen Activate button is hidden when there is a valid node-locked subscription license.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10980 Still images are not read as individual frames in Premiere on render to host
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Adobe Plug-In
| *Bug Description:* | Still images that are used across more than one frame are being treated as single frames when rendering to the Premiere timeline.
| *Workaround:* | Add a keyframe to one of the keyframable parameters in the Mocha Pro effect so Premiere knows to render on every frame.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10976 Renders using Fusion text as source will not render back to host
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Mocha effects applied to Fusion nodes that have frame ranges, such as text, will not register a render back in the host.
| *Workaround:* | Add an expression to any parameter in the image or text Fusion node. This forces Fusion to update the node frame every frame.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10974 "Add vertex" doesn't work on some edges
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The "Add vertex" option doesn't allow you to add a vertex for some mesh edges.
| *Workaround:* | None.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10951 Mocha crashes after deactivating on Big Sur
| *Platform:* | macOS
| *Product:* | All Products
| *Bug Description:* | Mocha will crash when deactivating a license on macOS Big Sur.
| *Workaround:* | None. Loading Mocha again should show it has deactivated.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Attempting to draw shift-constrained shapes in interlaced projects causes the shapes to be draw elongated instead of even.
| *Workaround:* | None.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | There is a missing cursor when working on modifying bezier tangents.
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10413 Mocha remove is not shown in the preview in Flame on Mac
| *Platform:* | macOS
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | GPU Remove will not render to the preview on macOS Flame.
| *Workaround:* | Switch off GPU processing in GPU preferences to render removes.
|===
...
* *Mocha Plug-in for OFX:* Autodesk Flame 2020 or Flame 2021. The Foundry Nuke 8-12. Fusion Studio 8-16. HitFilm Pro 2017 or higher. Silhouette 2020 or higher. Vegas Pro 14-17.
...
icon:exclamation-triangle[] The table below shows support for Mocha Pro when working with 2D footage.
...
icon:exclamation-triangle[] Due to the wrap-around nature of 360 footage, many data formats are +
