{
   ...
   "title": "Mocha Pro 2022 Release Notes"
}
:skip-front-matter:
:Author:    (C) Boris FX, Inc.
:Email:     support@borisfx.com
:Date:      13/09/2021
:Revision:  2022 v9.0.0
:icons:		font
:toc:
:showtitle:
...
This is a major release with several new features, performance improvements and defect fixes.
...
WARNING: Mocha Pro 2021 requires macOS 10.14 or higher for Intel CPUs or 10.15 and higher for Apple silicon M1 support. +
...
== Fixed issues since Mocha Pro 2021 v8.0.3

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8297 Keyframes aren’t created on the timeline when moving mesh points
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Keyframes are now created on the timeline when moving mesh points
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Weights are now kept for the current frame when clearing spline keyframes.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10692 Spline gets twisted after moving a point and continue tracking with 360 clip
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* |  Fixed spline geting twisted after moving a point with 360 clips
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10791 Splash screen looks blurry on 4k
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Splash screen no longer looks blurry on 4k monitors
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10810 Holding down COMMAND while working on Bezier tangents shows white block instead of cursor
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Replaced missing cursor when modifying bezier tangents.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10852 Exporting H264 Quicktime movie generates an error message
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Exporting H264 Quicktime movie no longer generates an error message.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10767 Shapes added to an imported FXS roto shape export from Mocha are jittery
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Shapes added to an imported FXS roto shape export from Mocha follow the track as expected
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11004 GStreamer cannot read 6K ProRes files
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | GStreamer can now read 6K ProRes files
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11038 Exporting Power Mesh Shapes to Silhouette Not Baked
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Silhouette shape exports from Mocha now bake in the spline warping keyframes
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11078 Mocha Remove only shows a single frame when it is turned on in AE when multi-threading is turned on
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Adobe Plug-in
| *Bug Description:* | Mocha Remove now shows more than a single frame when it is turned on in AE when multithreading is turned on.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11079 Apply matte is broken in AE when multithreading is turned on
| *Platform:* | All Platforms
| *Product:* |  Mocha Pro Adobe Plug-in
| *Bug Description:* | Apply matte is fixed in AE when multithreading is turned on
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* |  MO-11101 Standard AE masks cannot be linked to masks made by Mocha AE or Mocha Pro
| *Platform:* | All Platforms
| *Product:* |  Mocha Pro Adobe Plug-in
| *Bug Description:* | Standard AE masks can now be linked to masks made by Mocha AE or Mocha Pro
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* |  MO-11114 Adding multiple Fixed Frames in the Stabilize module is broken
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Adding multiple Fixed Frames in the Stabilize module is fixed
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11123 Clean plates are not correctly color managed in After Effects until you open the Mocha GUI.
| *Platform:* | All Platforms
| *Product:* |  Mocha Pro Adobe Plug-in
| *Bug Description:* | Clean plates are now correctly color managed in After Effects without opening the Mocha GUI.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11137 Mocha OFX Python doesn't load in Nuke 13
| *Platform:* | Windows
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Mocha OFX Python now loads in Nuke 13
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11138 Incorrect transformation data in Nuke when exporting a shape with multiple keyframes
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Corrected transformation data in Nuke when exporting a shape with multiple keyframes
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11141 Copied keyframes of a newly inserted mesh vertex will not paste
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Copied keyframes of a newly inserted mesh vertex will now paste correctly
|===


[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11180 Mesh regeneration retains old matte calculations
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mesh regeneration no longer retains old matte calculations which would leave gaps in meshes
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11191 Insert:Cutout doesn't combine alpha from insert clips correctly
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Insert:Cutout now combines alpha from insert clips correctly
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11212 "Create AE Masks" doesn't support non-latin unicode layer names
| *Platform:* | All Platforms
| *Product:* |  Mocha Pro Adobe Plug-in
| *Bug Description:* | "Create AE Masks" now supports non-latin unicode layer names
|===


[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11124 Slowdown in Fusion after pasting shapes from Mocha
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Slowdown no longer occurs in hosts after pasting shapes from Mocha
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11125 Mega and Clean Plate filenames always start at zero in the timeline when saving a plate in plugin
| *Platform:* | All Platforms
| *Product:* | All Plugins
| *Bug Description:* | Mega and Clean Plate filenames always started at zero in the timeline when saving a plate in plugin
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11273 Sporadic "Input frame doesn't exist" error in After Effects when tracking
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Adobe Plug-in
| *Bug Description:* | Mocha could throw an "Input frame doesn't exist" error when tracking in After Effects.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11303 Rendering output in Fusion on Windows is not working with alpha
| *Platform:* | Windows
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Rendering output in Fusion on Windows was not working with alpha
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11306 Linux Nuke can hang when copying and pasting "Basic" data from Mocha OFX
| *Platform:* | Linux
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Linux Nuke could hang when copying and pasting "Basic" data from Mocha OFX
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11308 "Apply Matte" in Mocha OFX crashes Fusion 17 on Windows
| *Platform:* | Windows
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | "Apply Matte" in Mocha OFX crashed Fusion 17 on Windows
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11315 Stabilize Warp Preview doesn't use brightness scaling
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Stabilize Warp Preview now uses brightness scaling
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11316 Inserts will not render if the layer contents are entirely out of canvas area.
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Inserts will now render if the layer contents are entirely out of canvas area
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11319 Mesh tracking doesn't have a progress bar
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The Mesh portion of the tracking now has a progress bar
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11356 Window cannot be shrunk horizontally until the Stabilize module is selected
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Fixed excessive minimum Mocha window width at startup
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11372 The viewer no longer reverts to input clip when viewing an un-rendered frame
| *Platform:* | All Platforms
| *Product:* | All Mocha Pro Plugins
| *Bug Description:* | Unrendered frames or frames that are cleared from the cache now correctly show the source clip if the option in preferences is checked.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Renaming a layer causes a referenced Insert foreground matte to reset to None.
| *Workaround:* | Reapply the matte in the dropdown after you rename the layer.
|===
...
| *Platform:* | Linux
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | The license tool can exit abruptly when using the GUI interface to activate.
| *Workaround:* | Use the command line to activate Mocha.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11012 Mocha does not remove correctly for source footage or cleanplates with transparency
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha will show incorrect remove patches when removing from footage with alpha regions of zero.
| *Workaround:* | Flatten the source footage or clean plates so there is no transparency in the frames.
|===
...
| *Platform:* | Windows and macOS
| *Product:* | All Products
| *Bug Description:* | An error occurs when attempting to export H.264 under the legacy QuickTime settings.
| *Workaround:* | Export a different format or export an image sequence.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Some Silhouette FXS shapes exported from Mocha have jitter in the transform data.
| *Workaround:* | None.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10750	Stabilize "Fixed Frames" can only set 1 frame when using timecodes instead of frames
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | If you are using timecode instead of frame view in the timeline, Fixed frames in Stabilize cannot list more than one frame.
| *Workaround:* | Switch to Frames view in the Clip module.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Some roto in 360 can become distorted when tracking.
| *Workaround:* | None.
|===
...
=== Windows
. Once the installation file, Mochapro2021-xxxx.exe, has been downloaded onto the system, double click the file to begin installation
. Follow the instructions on screen

=== OS X
. Once the installation file, Mochapro2021-xxxx.dmg, has been downloaded onto the system double click the application this will open a new window
...
=== Linux
. Once the installation file, Mochapro2021-xxxx.x86_64.rpm, has been downloaded, change into the directory you saved it into. Note that the ‘x’ in the file name is substituted by the current build number.
. Install the package with the command: +sudo rpm –Uvh Mochapro2021-xxxx.rpm+ or see the man page for your favorite package manager.
...
=== Linux Centos 7-8
. Once the installation file, Mochapro2021-xxxx.x86_64.rpm, has been downloaded, change into the directory you saved it into. Note that the ‘x’ in the file name is substituted by the current release build number.
. Install the package with the command: +sudo rpm -Uvh --nodeps Mochapro2021....rpm+ or see the man page for your favorite package manager.
