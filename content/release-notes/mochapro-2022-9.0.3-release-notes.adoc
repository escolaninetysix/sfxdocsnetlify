{
  "date": "2022-02-23T00:00:00-05:00",
   ...
   "title": "Mocha Pro 2022 v9.0.3 Release Notes"
}
:skip-front-matter:
:Author:    (C) Boris FX, Inc.
:Email:     support@borisfx.com
:Date:      23/02/2022
:Revision:  2022 v9.0.3
:icons:		font
:toc:
:showtitle:
...
== New features in Mocha Pro 2022 9.0.3

* *Faster High-Resolution ProRes playback:* High-resolution ProRes movies are now split into smaller internal chunks for more responsive scrubbing.

== New features in Mocha Pro 2022 9.0.2

* *ProRes Read/Write support on Apple silicon:* You can now read and write ProRes files on Apple M1 systems
