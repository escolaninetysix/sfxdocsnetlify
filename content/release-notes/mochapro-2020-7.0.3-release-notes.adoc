{
   ...
   "title": "Mocha Pro 2020 v7.0.3 Release Notes"
}
= Mocha(R) Pro 2020 v7.0.3 Release Notes

:Author:    (C) Boris FX/Imagineer Systems Ltd.
:Email:     support@borisfx.com
:Date:      22/10/2019
:Revision:  2020 v7.0.3
:icons:		font
...
This is a maintenance release to support Centos 8 along with several defect fixes.
...
== Fixed issues since Mocha Pro 2020 v7.0.2

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10381 Tracking at proxy resolution with imported Matte clips crashes the standalone
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Standalone
| *Bug Description:* | Tracking now works for imported matte clips at proxy resolution
|===
...
| *Bug Description:* | Garbage matte rendering now works for imported matte clips at proxy resolution
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10372	Mocha crashes when opening a project with no clips
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha no longer crashes when trying to open a corrupted project that has no clips
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10368	Viewer preferences no longer populates colorspace drop-downs when using the OCIO env variable
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha now displays the correct OCIO configurations when using an environment variable.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10365	Silhouette crashes on Mac when loading a Mocha instance which is set up to do an Insert Render
| *Platform:* | macOS
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Silhouette no longer crashes when loading a project with an Insert render
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10362	Prevent loading of the MediaIOServer on Catalina macOS
| *Platform:* | macOD
| *Product:* | All Products
| *Bug Description:* | Launching Mocha on Catalina could cause problems with MediaIOServer which would hang hosts.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10344	A flash of dark frame is seen when Mocha is launched through Nuke.
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Mocha could flash between the default colorspace and the current Nuke colourspace when first opening the GUI.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10334 Mocha does not show remove frames after re-entering Mocha until you render 1 frame
| *Platform:* | All Platforms
| *Product:* | All Plugins
| *Bug Description:* | Mocha plugins will now show cached render frames when returning to a current session.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10326	Full Screen mode on Windows disables GUI menu actions
| *Platform:* | Windows
| *Product:* | All Products
| *Bug Description:* | Setting Mocha's internal Fullscreen mode in preferences no longer disables menu actions and dropdowns.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10325	Stationary masks flicker or buzz in interlaced projects (Mocha Pro, Continuum, and Sapphire)
| *Platform:* | All Platforms
| *Product:* | All Plugins
| *Bug Description:* | Interlaced projects could show flickering masks when rendering to the host
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10323	Various OCIO LUTs are missing
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Some OCIO Luts were missing. They have been restored.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10318	Imported Matte Clips are not used by remove layer
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Import matte clips are now being used by the Remove module.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10303 Mouse cursor is not visible in the preview when tracking while using area paint brush
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | When tracking with the area brush tool selected, the cursor now updates.
|===
...
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-In
| *Bug Description:* | Mocha projects with negative frame offset no longer export Nuke Roto with incorrect frames
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Snapping primitive shapes could cause them to leap out of place or collapse.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10235	Mocha Standalone Window size does not restore back to how it was closed out
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha Pro standalone now remembers a window size change on restart.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Area Brush is now much faster, especially with large brushes.
|===
...
| *Platform:* | Windows
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Mocha no longer sporadically starts up unlicensed on Vegas.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10180 Remove with Mega Clean Plate does not render correctly when used in plugin with a standalone project
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mega Clean Plates now render correctly when a project is transferred from the standalone to a plugin.
|===
