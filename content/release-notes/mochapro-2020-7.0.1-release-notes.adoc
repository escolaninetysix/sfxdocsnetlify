{
   ...
   "title": "Mocha Pro 2020 v7.0.1 Release Notes"
}

= Mocha(R) Pro 2020 v7.0.1 Release Notes

:Author:    (C) Boris FX/Imagineer Systems Ltd.
:Email:     support@borisfx.com
:Date:      22/10/2019
:Revision:  2020 v7.0.1
:icons:		font
...
There are no new features for Mocha Pro 2020 v7.0.1. This is a maintenance release to fix several defects.
...
== Fixed issues since Mocha Pro 2020 v7.0.0

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10012 Crash when trying to track sequences with large frame offset
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Tracking with a very large frame offset no longer causes a crash
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10132	Cannot re-position zoom window
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | You can now reposition the zoom window.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10195 Mocha in Vegas sometimes starting up as unlicensed
| *Platform:* | Windows
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Mocha in Vegas was sometimes starting up as unlicensed
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10196 Tracked spline gets moved when keyframe gets created
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | A tracked spline will no longer move when a keyframe gets created
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10209	Spline points aren't visible after using the paint brush until you deselect and reselect the layer
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | After creating a spline with Area Brush, the spline now appears selected.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10210 Erase paint area mode creates a spline when Quick Mask is not selected
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | MO-10210 Erase paint area mode no longer creates a spline when Quick Mask is not selected.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10242 Rendering in Vegas causes host to crash if Deprecated QuickTime support is not enabled
| *Platform:* | Windows
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Vegas 17 will no longer crash when rendering in the Mocha GUI if Deprecated QuickTime support is not enabled in Vegas preferences.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10246 Extra cog appearing in layer controls when switching to another module
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | MO-10246 Fixed extra cog column appearing in layer controls when switching to another module.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10247 Rendering Megaplate Remove in Vegas 17 caused the host to crash for some projects
| *Platform:* | Windows
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Rendering removes with a Mega Plate could cause some Vegas projects to crash.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10256 Mocha Pro GUI occasionally displays black frames in Vegas with a GeForce card
| *Platform:* | Windows
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | The Mocha Pro OFX GUI occasionally displayed black frames in Vegas with a GeForce card.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10259 X-Spline layer shows duplicate "full" sized shape when switching proxy resolutions
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | X-Splines could show a duplicate layer in the viewer if the proxy resolution changed.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10263 User Guide shows Layer Detail in the toolbar instead of Layer controls
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | User Guide no longer shows Layer Detail in the toolbar instead of Layer controls.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10264 Exports to clipboard on macOS not pasting into After Effects
| *Platform:* | macOS
| *Product:* | All Products
| *Bug Description:* | Fixed exports to clipboard on macOS not pasting into After Effects.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10269 In Vegas Pro 17, changes in the Mocha GUI not applying to the rendered results
| *Platform:* | Windows
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | In Vegas Pro 17, changes in the Mocha GUI were not applied to the rendered results
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10272 During contour creation, deselecting the contour being created causes an error message
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Deselecting a contour being created no longer causes an error message.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10291	Create Track Data always defaults to top layer
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Adobe Plug-In
| *Bug Description:* | The "Create Track Data" layer selection now remains constant.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10287	Mocha projects with negative frame offset export Nuke Roto with incorrect frames
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-In
| *Bug Description:* | Mocha projects with negative frame offset export Nuke Roto with incorrect frames
| *Workaround:* | Set offset to 0 and export. Data may need to be shifted in Nuke.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10277 “Import Shapes” menu item does nothing when trying to import SFX projects
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Standalone
| *Bug Description:* | "Import shapes" in the file menu is currently not working correctly.
| *Workaround:* | None.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10265	Using Snap on a rectangle shape causes large shape deformation
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Rectangle shapes can snap incorrectly when using the Alt+S snap tool.
| *Workaround:* | Drag the point instead.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10235	Mocha Standalone Window size does not save to preferences
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha Pro standalone does not remember a window size change on restart.
| *Workaround:* | None.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10201	Area Brush painting can be slow
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | On some systems with large brushes, Area Brush can slow down signficantly
| *Workaround:* | User a smaller brush.
|===
...
- *Mac:* macOS X 10.12.x or higher, on Intel.
...
* *Mocha Plug-in for OFX:* Autodesk Flame 2020. The Foundry Nuke 8-12. Fusion Studio 8-16. HitFilm Pro 2017 or higher. Silhouette 6-7. Vegas Pro 14-17.

NOTE: While Mocha will function in Resolve 16, currently we do not officially support Resolve in this release.

=== Operating System

- *Mac:* OS X 10.12.x or higher, on Intel.
- *Windows:* Windows 7, Windows 8 and Windows 10 on x64.
- *Linux:* Red Hat Enterprise Linux 5&6, CentOS 5&6, or a compatible Linux distribution on x86_64.
