{
   ...
   "description": "Mocha Pro 5.6.0 release notes",
   "excerpt": "This is a patch update to add new stereo support as well as containing several important defect fixes and improvements. Release notes cover Mocha Pro and Mocha VR, for both standalone and plugin versions of the product.",
   "image_url": "",
   "tags": [
      "Mocha"
   ],
   "title": "Mocha Pro and VR 5.6.0 - Release Notes"
}
...
These release notes accompany mocha *{revision}*.

This is a patch update to add new stereo support as well as containing several important defect fixes and improvements.

Release notes cover mocha Pro and mocha VR, for both standalone and plugin versions of the product.
...
IMPORTANT: OFX builds of the mocha Pro and VR Plugin have been tested to work with The Foundry Nuke, Blackmagic Fusion Studio, HitFilm Pro, Vegas Pro and Silhouette v6. +
Other hosts that utilize OFX may operate the mocha Pro OFX Plugin correctly, but at this stage they are unofficially supported and may experience problems.


WARNING: Version {revision} introduces new inputs into the mocha AVX plugin that may not be backwards compatible with earlier versions of mocha AVX. See MO-8732 in "Known defects" below.

Python is not supported in the plugin versions of *mocha Pro* or *mocha VR*. This means any tools created by Python will not be functional. This includes some exports such as Silhouette shapes.

== New Features in mocha Pro {revision}
...
== New Features in mocha VR {revision}
...
== Fixed issues since 5.5.2

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8926 Errors in Python scripting reference: SpotCleaner tool example
| *Platform:* | All Platforms
| *Product:* | Standalone Products
| *Bug Description:* | There were a number of code errors in the SpotCleaner example that would stop the script from running.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8901 Reorient jumps about when moving between layers
| *Platform:* | All Platforms
| *Product:* | All Mocha VR
| *Bug Description:* | Reorient now blends correctly between multiple layers
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8899 The Horizon overlay in the Reorient module cannot be disabled if Preview is disabled
| *Platform:* | All Platforms
| *Product:* | All Mocha VR
| *Bug Description:* | Horizon overlay is now hidden correctly when Preview is off.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8887 Feather preview artifacts in VR 360
| *Platform:* | All Platforms
| *Product:* | Mocha VR All
| *Bug Description:* | Feather looked incorrect on Inserts in 360 mode.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8885 Nuke occupies all RAM when rendering matte
| *Platform:* | All Platforms
| *Product:* | mocha Pro OFX Plug-in, mocha VR OFX Plug-in
| *Bug Description:* | We now handle RAM in Nuke more efficiently.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8876 Entering an Insert Opacity of 0.01 shows as zero in the GUI
| *Platform:* | All Platforms
| *Product:* | Mocha Pro All
| *Bug Description:* | Insert Opacity has been changed to a percentage to help opacity granularity.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8857 Mocha plug-in crash in Fusion when footage has only one frame
| *Platform:* | All Platforms
| *Product:* | mocha Pro OFX Plug-in, mocha VR OFX Plug-in
| *Bug Description:* | Mocha can now handle 1-frame clips in Fusion.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8851 Low quality resampling when using Render: Lens: Distort
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Lens:Distort is using higher quality resampling for more accurate results.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8850 "Too many frames" error in Nuke when attempting to use the mocha OFX plugin on some shots
| *Platform:* | All Platforms
| *Product:* | mocha Pro OFX Plug-in, mocha VR OFX Plug-in
| *Bug Description:* | Nuke could throw an error about "Too Many Frames" when using the mocha plugin. This has been addressed.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8847 Remove blend rendering is incorrect after changing dissolve width
| *Platform:* | All Platforms
| *Product:* | Mocha Pro All, Mocha VR All
| *Bug Description:* | Remove blending now blends correctly.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8843 "Reset All" needs to be clicked twice to reset Reorient.
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Clicking "Reset All" now corectly resets all values to Zero in the Reorient module
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8833 Exporting shape data to the clipboard crashes After Effects CC 2018
| *Platform:* | All Platforms
| *Product:* | Mocha Pro All, Mocha VR All
| *Bug Description:* | Copying shape data to the clipboard and trying to paste to AE would crash AE. Adobe have since addressed this in a new After Effects patch.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8816 On Mac, moving a surface corner in Manual Track mode does not change the shape
| *Platform:* | Mac OS
| *Product:* | All Products
| *Bug Description:* | Manual track now updates the shape correctly on Mac OS
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8811 Surface disappears when attempting to move using translate tool in manual track
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Attempting to move the surface using the "Q" translate tool in manual track now handles the surface correctly.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8804 Mocha's Python module can't be used when PySide is installed system-wide
| *Platform:* | All Platforms
| *Product:* | mocha Pro Standalone, mocha VR Standalone
| *Bug Description:* | Mocha package is now able to be installed into the system-wide package when there is another PySide installed.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8803 Nuke hangs when attempting to do Undistort/Distort workflow with mocha VR
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Creating a Lens:Undistort to Lens:Distort node workflow no longer hangs Nuke.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8798 Adjusting colorspace parameters throws file error
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Adjusting colorspace parameters no longer throws a file error
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8790 Plug-in rendering performance degrades significantly as more frames are rendered, leading to very slow renders in long sessions.
| *Platform:* | All Platforms
| *Product:* | All Plugins
| *Bug Description:* | Rendering is now optimised in the host to remain consistent over time.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8787 Remove Blend is not blending on some frames
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Remove blend is blending correctly on all frames.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8785 Interpolated illumination modelling in VR remove creates a circle on the pole
| *Platform:* | All Platforms
| *Product:* | Mocha VR All
| *Bug Description:* | Rendering a remove with interpolated illumination modelling no longer creates a circular light on the remove area.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8777 On Mac, HitFilm 2017 and MC crash when the Mocha GUI is quit.
| *Platform:* | Mac OS
| *Product:* | All Products
| *Bug Description:* | Media composer and HitFilm no longer have exit problems.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8770 Adobe plug-in installer on Mac does not list CC 2017 as a Host to install for.
| *Platform:* | Mac OS
| *Product:* | All Products
| *Bug Description:* | We now show AE CC 2017 as one of the host options.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8769 In/Out range markers are not visible unless zoomed out to full range
| *Platform:* | All Platforms
| *Product:* | mocha Pro Adobe Plug-in, mocha Pro Avid Plug-in, mocha Pro OFX Plug-in, mocha Pro Plug-in
| *Bug Description:* | Setting an In or Out point now shows the markers in the right place.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8766 License is lost on running multiple instances of mocha Pro on Linux
| *Platform:* | Linux
| *Product:* | All Products
| *Bug Description:* | You can now run multiple instances of nodelocked Mocha Pro locally without losing the license
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8761 Transparent frames when animating matte feather over time
| *Platform:* | macOS and Windows
| *Product:* | All Products
| *Bug Description:* | Animating a matte feather over time no longer shows transparent glitches in the image.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8740 GPU memory allocation failure
| *Platform:* | All Platforms
| *Product:* | Mocha Pro All, Mocha VR All
| *Bug Description:* | Memory allocation on the GPU is more robust.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8737 Wrong update file is offered/downloaded when multiple plugins are present on the system.
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | If you have multiple types of mocha on the system we no longer offer the wrong update download.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8736 Python crashes mocha when running some GUI-based scripts
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Python Ventilation is now switched off by default to avoid issues in GUI scripts.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8732 Mocha AVX projects saved with 5.5.2 show black frames in 5.5.1
| *Platform:* | All Platforms
| *Product:* | mocha VR AVX Plug-in, mocha Pro AVX Plug-in
| *Bug Description:* | Opening a project that was saved in mocha AVX v5.5.2 with Media Composer running mocha AVX 5.5.1 shows black frames when you open the mocha GUI.
| *Workaround:* | None. This is a software limitation on the Media Composer side.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8726 Mocha does not show an error on RLM heartbeat failure
| *Platform:* | Linux
| *Product:* | All Products
| *Bug Description:* | We now show an error when RLM license is lost.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8713 Mocha renders replace  black when illumination is set to interpolate
| *Platform:* | Linux CentOS, Windows 10
| *Product:* | mocha VR OFX Plug-in
| *Bug Description:* | A rare issue caused some remove renders to remove as black. This has been fixed.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8712 Incorrect Replace when rendering remove in Nuke on some Linux machines
| *Platform:* | Windows, Linux
| *Product:* | mocha VR OFX Plug-in
| *Bug Description:* | Remove was occasionally not patching correctly. This has been fixed.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8711 Python crashes mocha when using watchers on tracking
| *Platform:* | All platforms
| *Product:* | All Standalone Products
| *Bug Description:* | We have addressed crashes related to watchers.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8707 Loss of precision of the MaxMotionX and MaxMotionY parameters while changing Proxy Scale
| *Platform:* | All Platforms
| *Product:* | Mocha Pro All, Mocha VR All
| *Bug Description:* | Proxies were Auto search area values too low. This has been adjusted to a value relative to the proxy size.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8701 On a Mac with only an Iris GPU, tracking and matte rendering leaks memory leading to a crash
| *Platform:* | Platform: A Mac with no discrete GPU.
| *Product:* | Mocha Pro All, Mocha VR All
| *Bug Description:* | GPU memory stability for Iris GPUs has been addressed.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8697 Failure to save cleanplate when changing AE bitdepth
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | When you launch a mocha project from AE it no longer gets stuck at the bit depth AE is set at when first applying the plugin.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8692 Apple Motion Basic Tracking data is drifting
| *Platform:* | macOS
| *Product:* | All Products
| *Bug Description:* | Exporting tracking data to Apple motion is no longer showing drift in the track.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8606 Mocha wont apply generated tracking data at correct time if a tracked layer has a different inpoint than source
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Generated tracking data is now applying at the right point, regardless of in point.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8593 Überkey does not turn off when reopening mocha GUI in plugin
| *Platform:* | All Platforms
| *Product:* | mocha Pro Adobe Plug-in, mocha Pro Avid Plug-in, mocha Pro OFX Plug-in, mocha VR Adobe Plug-in
| *Bug Description:* | Überkey is now correctly turned off when switching back to the plugin.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8572 "Reset" button has no effect on the the Scale parameter in the Transform Tab of the Insert Module in all versions of Mocha
| *Platform:* | Mac OS 10.11.6, Windows 10, CentOS 6
| *Product:* | Mocha Pro All, Mocha VR All
| *Bug Description:* | Reset now resets Insert parameters correctly.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8555 The on-screen widget of the Horizon Orient moves VR image in undesired ways after using Horizon Align
| *Platform:* | Mac OS 10.11.6, Windows 10, CentOS 6
| *Product:* | Mocha VR All
| *Bug Description:* | The view control now moves as expected in Reorient.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8422 mocha Pro Adobe Plugin: Pasting shape data to a trimmed clip in Premiere pads the keyframes
| *Platform:* | Mac OS, Windows
| *Product:* | Mocha Pro Adobe Plugin, Mocha VR Adobe Plugin
| *Bug Description:* | Shape data now pastes to the trimmed clip start, rather than paddign to the original source clip start.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8386 Fusion shape export does not export feathering
| *Platform:* | All Platforms
| *Product:* | All Mocha OFX plugins
| *Bug Description:* | Shape data exported to fusion now exports edge feathering.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8368 Adjusting a manual track after tracking causes whole timeline to offset
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Manual track now works correctly! Previously it was offsetting the whole animation when adjusting on the timeline.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8365 Apply matte does not work in AE in 4k projects on windows when host proxy scale is set to "Third"
| *Platform:* | Mac OS and Windows
| *Product:* | All Products
| *Bug Description:* | "Third" Proxies now work correctly with 4K footage and mocha mattes.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8314 Fusion - Background not solid white when View and Invert Matte buttons checked and feather is not set to a whole number
| *Platform:* | All Platforms
| *Product:* | mocha Pro OFX Plug-in, mocha VR OFX Plug-in
| *Bug Description:* | Mattes were not displayed correctly when using inserted feathering.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8313 Fusion - Controls aren’t contained inside dropdowns in the host
| *Platform:* | All Platforms
| *Product:* | mocha Pro OFX Plug-in, mocha VR OFX Plug-in
| *Bug Description:* | Controls in Fusion are now correctly contained in twirl-down categories.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8259 Renaming clean plates upon creation results in a colorspace error and fails to save off the image
| *Platform:* | Mac OS, Windows 10, CentOS 6
| *Product:* | All Products
| *Bug Description:* | Clean plates will now save correctly without error.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-7870 Tracking outside of canvas results in ghost frames
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Viewer has stopped showing ghost frames when tracking minimal or no data.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-7525 Shapes and masks imported in AE are incorrect if they belong to a Bezier layer with corner points
| *Platform:* | Mac OS, Windows
| *Product:* | All Products
| *Bug Description:* | Cornered Bezier splines now export correctly to AE.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-6961 Interlaced parameters are enabled for non-interlaced projects
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Interlaced parameters are turned off for non-interlaced parameters.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-6735 Changing proxy scale by mouse wheel doesn't update the canvas
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | You can now update the proxy by mouse scroll.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-6448 Colorspace and Interlaced parameters are enabled for rendered clips
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Colorspace and interlaced parameters are not required for rendered clips, so they have been disabled.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-4728 "Feather" in the Insert Module does not draw correctly in 360 View in all versions of Mocha VR
| *Platform:* | Mac OS 10.11.6, Windows 10, CentOS 6
| *Product:* | Mocha VR All
| *Bug Description:* | "Feather" in the Insert Module now draws correctly in 360 View
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-4725 Reference point for layer at the seam can't be selected in AdjustTrack
| *Platform:* | All Platforms
| *Product:* | Mocha VR All
| *Bug Description:* | You can now adjust reference points around the seam in Mocha VR.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-250 Remove Blend is not blending when rendering more than once
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Remove rendering is no longer cumulative.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-151 Hovering over Render Buttons in mocha modules reveals the incorrect label
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Render buttons now say "Render" instead of "Track"
|===
...
| *Product:* | Mocha VR Adobe Plugin, Mocha Pro Adobe Plugin
...
When using a Mocha Pro node, saving and executing any changes within the plugin appears to stop the crashes.
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8834 First attempt at exporting data to Premiere will not paste from mocha Pro Plugin
| *Platform:* | Mac OS and Windows.
| *Product:* | mocha Pro Adobe Plug-in, mocha VR Adobe Plug-in
...
| *Platform:* | mac OS and Windows
| *Product:* | mocha Pro Adobe Plug-in, mocha VR Adobe Plug-in
| *Bug Description:* | Changing the frame rate in Premiere after using the mocha plugin can cause the renders to be incorrect.
| *Workaround:* | None
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8721 Plugin crash when texture memory is too low
| *Platform:* | All Platforms
| *Product:* | All Products
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8716 Plugin fails to render on headless render farms
| *Platform:* | Linux
| *Product:* | mocha Pro OFX Plug-in, mocha VR OFX Plug-in
| *Bug Description:* | Attempting to render Nuke projects containing mocha OFX plugins on a render farm that is headless will throw an error.
...
| *Platform:* | Windows
| *Product:* | mocha Pro OFX Plugin, mocha VR OFX Plugin
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8653 Exporting tracking data supplies additional extension rather than layer name in plugin save dialogs
| *Platform:* | All Platforms
| *Product:* | All Plugins
| *Bug Description:* | Exporting tracking data shows two extensions rather than a layer name when using the plugin.
| *Workaround:* | None.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8647 Applying tracking data via mocha Adobe plugin to a 3d null will set Z scale to 0
| *Platform:* | All Platforms
| *Product:* | mocha Pro Adobe Plugin, mocha VR Adobe Plugin
| *Bug Description:* | Applying mocha transform data to a 3d Null in AE via the plugin UI will set a 3d null Z scale parameter to 0.
...
| *Platform:* | macOS and Windows
| *Product:* | mocha Pro Adobe Plugin, mocha VR Adobe Plugin.
| *Bug Description:* | A mocha plugin applied to any comp with native AE time manipulation (such as stretch) will not work predictably.
| *Workaround:* | None
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8645 Plugin masks wont follow rendered stablize footage
| *Platform:* | All Platforms
| *Product:* | All Plugin Versions
| *Bug Description:* | Apply Matte will applu the tracked matte, not a stabilized matte, when rendering Stabilize to the mocha plugin host.
| *Workaround:* | None.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8637 Mocha projects exported from the plugin version show an "Insert Layer" when loaded into the standalone version
| *Platform:* | All Platforms
| *Product:* | Mocha Pro All, Mocha VR All
| *Bug Description:* | If you export a project from the plugin version, importing into Standalone still shows the Lnsert Layer Clip.
| *Workaround:* | None.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8611 Mocha Pro/VR OFX Plugin do not load in extra frames if a clip is expanded beyond its initial runtime in Vegas
...
| *Workaround:* | Expand the clip first, then apply Mocha Pro/VR OFX Plugin
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8609 Mocha does not load in the correct number of frames into the Mocha UI if the user first applies Mocha VR and Pro OFX plugin and then adjusts the clips length in Vegas
...
| *Workaround:* | Adjust clips length first, then add Mocha Pro/VR OFX plugin
|===
...
| *Workaround:* | Checking and unchecking the "Render" in the Mocha VR plugin parameters removes the "wobbly" frames.
|===
...
| *Platform:* | All Platforms
| *Product:* | mocha Pro OFX Plug-in, mocha VR OFX Plug-in
| *Bug Description:* | If you create a project in one instance of the mocha plugin, its contents may appear when you apply a second plugin somewhere else in Resolve.
...
| *Platform:* | MacOS
| *Product:* | mocha Pro OFX Plug-in, mocha VR OFX Plug-in
| *Bug Description:* | Pressing Undo does not undo the tracking steps in OFX plugins on Mac
...
| *Platform:* | All Platforms
| *Product:* | mocha Pro AVX Plugin, mocha VR AVX Plugin
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8417 Mocha Pro Plugin - AVX - cannot cancel timeline render while in progress
| *Platform:* | All Platforms
| *Product:* | mocha Pro AVX Plugin, mocha VR AVX Plugin
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8414 Mocha Pro Plugin - Fusion - Premultiply Output label is cut off in host UI
| *Platform:* | All Platforms
| *Product:* | mocha Pro OFX Plugin, mocha VR OFX Plugin
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8412 Mocha Pro AVX Plugin- Background rendering fails in Avid MC versions older than 8.6.4
| *Platform:* | Windows
| *Product:* | mocha Pro AVX Plugin, mocha VR AVX Plugin
| *Bug Description:*| If you are attempting to do a background render with the mocha Pro Plugin on MC 8.6.3 or earlier, the render fails.
| *Workaround:* | Render in 8.6.4 or do a standard render.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8411 Mocha Pro Plugin - Premiere gives low-level exception then crashes when resizing video during playback
| *Platform:* | OS X
| *Product:* | mocha Pro Adobe Plugin, mocha VR Adobe Plugin
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8392 Cannot undock panels in mocha Pro Plugin GUI
| *Platform:* | All Platforms
| *Product:* | All Plugins
| *Bug Description:*| Panels cannot be undocked in the plugin
| *Workaround:* | None.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8391 mocha Pro Plugin: Viewer preferences appear behind mocha Plugin window
| *Platform:* | All Platforms
| *Product:* | All Plugins
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8383 mocha Pro Plugin: ".bundle" in dock when running plugin if "Blackmagic Codec.Component" installed
| *Platform:* | All Platforms
| *Product:* | All Plugins
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8305 Frame range changes for *.mov files are not visible in mocha OFX plugin
| *Platform:* | All Platforms
| *Product:* | mocha Pro OFX Plugin, mocha VR OFX Plugin
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8304 mocha Pro Plugin OFX: OS X Nuke menu is disabled if access during mocha GUI session
| *Platform:* | OS X
| *Product:* | mocha Pro OFX Plugin, mocha VR OFX Plugin
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8193 Tracking in AE via an adjustment layer will keep cache from last open mocha plugin instance
| *Platform:* | All Platforms
| *Product:* |  mocha Pro Adobe Plugin,  mocha VR Adobe Plugin
| *Bug Description:*| Adjustment layers don't always give correct source inputs.
| *Workaround:* | Apply directly to the clip.
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8183 mocha Plugin: Copy and Paste commands are disabled in Edit menu if a layer is selected
| *Platform:* | All Platforms
| *Product:* | All Plugins
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8147 No warning if clip is timestretch/timeremapped changed from initial track in plugin
| *Platform:* | All Platforms
| *Product:* | All Plugins
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8107 Updating mocha Pro Adobe Plugin 2D parameters hangs After Effects for a very long time
| *Platform:* | All Platforms
| *Product:* | mocha Pro Adobe Plugin, mocha VR Adobe Plugin
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8055 Project in/out doesn't draw in the mocha plugin UI
| *Platform:* | All Platforms
| *Product:* | All Plugins
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8049 Duplicated frames for mismatching frame rates in mocha Pro Plugin in Premiere and Avid MC
| *Platform:* | All Platforms
| *Product:* | mocha Pro Adobe Plugin, mocha Pro AVX Plugin, mocha VR Adobe Plugin, mocha VR AVX Plugin
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-8000 Proxy error is shown when launching mocha Pro Plugin if the playhead is out of the trimmed frame range
| *Platform:* | All Platforms
| *Product:* | All Products
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-7986 There are redundant shortcuts in the Key Shortcuts dialog in mocha Pro plugin
| *Platform:* | All Platforms
| *Product:* | All Products
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-7974 mocha Pro Plugin effect isn't redrawn after license/unlicense the plugin
| *Platform:* | All Platforms
| *Product:* | All Products
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-7951 mocha Pro AE plugin stutters frames if AE is playing when launching mocha
| *Platform:* | All Platforms
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-7941 mocha Pro AE plugin does not read in output of effects above it in the Effects stack
| *Platform:* | All Platforms
| *Product:* | mocha Pro Adobe Plugin, mocha VR Adobe Plugin
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-7932 Wrong program name when installing/uninstalling the mocha Pro Plugin on Windows
| *Platform:* | Windows
| *Product:* | All Plugins
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-4899 Zoom window can be manipulated when switched off
| *Platform:* | All Platforms
| *Product:* | All Products
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | AdjustTrack Module's Reference Point Onscreen Widgets expand and shrink according to Footage Resolution (in the Standalone), and also the Proxy Resolution in the Host Applications of the Plugin Versions.
| *Workaround:* | None.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Tweaking parameters in Source Tab of the Insert Module can sporadically crash plugin hosts and mocha Standalone (Pro and VR).
| *Workaround:* | None.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-166 Avid can hang when using the "Render Effect" command with the Remove Module in mocha VR AVX plugin
| *Platform:* | All Platforms
| *Product:* | mocha VR AVX Plugin
| *Bug Description:* | Media Composer can sometimes hang after clicking "Render Effect" when rendering the Remove clip with the mocha VR AVX plugin.
| *Workaround:* | None.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-162 Crop mask in mocha plugin does not rescale correctly when jumping between different proxy resolutions
| *Platform:* | All Platforms
| *Product:* | All Plugins
| *Bug Description:* | The Crop mask in the Clip Module of mocha Pro/VR plugin does not rescale correctly when jumping between different proxy resolutions.
| *Workaround:* | None.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-160 Zoom Window does not adjust to different proxy sizes in mocha Pro/VR plugins
| *Platform:* | All Platforms
| *Product:* | All Plugins
| *Bug Description:* | Zoom Window does not adjust to different proxy sizes in mocha Pro/VR plugins
| *Workaround:* | None.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-145 Unnecessary output tab in the reorient module of mocha VR plugin
| *Platform:* | All Platforms
| *Product:* | mocha VR Plugins
| *Bug Description:* | the output tab is redundant in Reorient for the plugin version of mocha VR.
| *Workaround:* | None.
|===
...
== Software Requirements for mocha Standalone
...
== Software Requirements for mocha Plugins

=== Host Applications

The mocha Pro Plugins officially support the following host applications:

* *mocha Plugin for Adobe:* Adobe After Effects & Premiere CC or higher.
* *mocha Plugin for Avid:* Avid Media Composer 7.0.6 or higher
* *mocha Plugin for OFX:* The Foundry Nuke 8 or higher. Fusion Studio 8 or higher. HitFilm Pro 2017 or higher. Silhouette 6 or higher.
...
IMPORTANT: The table below shows support for mocha Pro and mocha VR when working with 2D footage.
...
=== Windows
. Once the installation file, mochapro-5.6.0-xxxx.exe, has been downloaded onto the system, double click the file to begin installation
. Follow the instructions on screen

=== OS X
. Once the installation file, mochapro-5.6.0-xxxx.dmg, has been downloaded onto the system double click the application this will open a new window
...
=== Linux
. Once the installation file, mochapro-5.6.0-xxxx.x86_64.rpm, has been downloaded, change into the directory you saved it into. Note that the ‘x’ in the file name is substituted by the current build number.
. Install the package with the command: +sudo rpm –Uvh mochapro-5.6.0-xxxx.rpm+ or see the man page for your favorite package manager.
...
=== Linux Centos 7
. Once the installation file, mochapro-5.6.0-xxxx.x86_64.rpm, has been downloaded, change into the directory you saved it into. Note that the ‘x’ in the file name is substituted by the current release build number.
. Install the package with the command: +sudo rpm -Uvh --nodeps mochapro-5.6.0....rpm+ or see the man page for your favorite package manager.
...
== Installation of mocha VR Standalone

=== Windows
. Once the installation file, mochaVR-5.6.0-xxxx.exe, has been downloaded onto the system, double click the file to begin installation
. Follow the instructions on screen

=== OS X
. Once the installation file, mochaVR-5.6.0-xxxx.dmg, has been downloaded onto the system double click the application this will open a new window
. Drag the *{revision}* application bundle to the folder where *mocha* will be installed. The conventional place to install applications is in the ‘Applications’ folder on Macintosh HD.
. Run *{revision}*

=== Linux
. Once the installation file, mochaVR-5.6.0-xxxx.x86_64.rpm, has been downloaded, change into the directory you saved it into. Note that the ‘x’ in the file name is substituted by the current build number.
. Install the package with the command: +sudo yum install mochaVR-5.6.0-*.rpm+ or see the man page for your favorite package manager.
. Installing via rpm may prompt you to install additional dependencies, such as compat-glibc or xrandr. If these are required, download and install them using the appropriate method for your distribution, for example ‘yum’ or ‘up2date’.

=== Linux Centos 7
. Once the installation file, mochaVR-5.6.0-xxxx.x86_64.rpm, has been downloaded, change into the directory you saved it into. Note that the ‘x’ in the file name is substituted by the current release build number.
. Install the package with the command: +sudo yum install mochaVR-5.6.0-*.rpm+ or see the man page for your favorite package manager.

NOTE: Your Linux package manager should automatically install the xclip dependency if it's available in the local repository. +
On CentOS you have to enable epel repo (yum install epel-release) to make sure xclip is available.

== Installation of mocha Pro Plugin
...
=== Linux
. Once the installation file, (e.g 'mochaPro[PluginType]-rhel-xxxx.rpm'), has been downloaded onto the system, double click the RPM
...
== Installation of mocha VR Plugin

=== Windows
. Once the installation file, (e.g. 'mochaVR[PluginType]-win-xxxx.msi'), has been downloaded onto the system, double click the file to begin installation
. Follow the instructions on screen

=== OS X
. Once the installation file, (e.g 'mochaVR[PluginType]-mac-xxxx.dmg'), has been downloaded onto the system double click the DMG and his will open a new window
. Double-click the mochaPro Plugin .pkg inside and follow the on-screen instructions

=== Linux
. Once the installation file, (e.g 'mochaVR[PluginType]-rhel-xxxx.rpm'), has been downloaded onto the system, double click the RPM
. Install the package with the command +sudo yum install mochaVROFX-*.rpm+ or see the man page for your favorite package manager.
