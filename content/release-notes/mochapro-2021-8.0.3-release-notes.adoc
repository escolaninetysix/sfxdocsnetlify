...
This is a maintenance release with some performance improvements and defect fixes.
...
== New features in Mocha Pro 2021 v8.0.3

* *Updated RED R3D SDK Support:* RED R3D support has been upgraded to the latest version (8.0.1).
...
== Fixed issues since Mocha Pro 2021 v8.0.2

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11081 Crash in Vegas 18 during playback involving a Mocha Pro plugin instance
| *Platform:* | Windows
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Vegas 18 would occasionally crash attempting to play back Mocha Pro renders.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11082 Crash in Mocha UI when rendering a Remove with GPU rendering enabled
| *Platform:* | All Platforms
| *Product:* | All Mocha Pro Plug-ins
| *Bug Description:* | Removes could crash on some systems when trying to play back a render in the host timeline.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11086 Mocha Pro occasionally fails to render when loading a HitFilm Project in Vegas
| *Platform:* | Windows
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Importing a Hitfilm project into Vegas would sometimes not render Mocha effects in the project.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11095 HiDPI Auto Detection on Linux Is Broken
| *Platform:* | Linux
| *Product:* | All Products
| *Bug Description:* | Screen scale detection on Linux could cause Mocha's UI to be drawn with text and widgets at different scales.
| *Additional Notes:* | To enable scaling on Linux, use the QT_SCREEN_SCALE_FACTORS environment variable. For example, on a dual monitor system: QT_SCREEN_SCALE_FACTORS=2.0;2.0
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11092 EError when trying to import ssl when externally running Mocha Python
| *Platform:* | All Platforms
| *Product:* | All Products
...
* *Mocha Plug-in for OFX:* Autodesk Flame 2020 or Flame 2021. The Foundry Nuke 8-12. Fusion Studio 8-16. HitFilm Pro 2017 or higher. Silhouette 2020 or higher. Vegas Pro 14-18.
...
=== Screen Scale on Linux
Automatic screen scale detection is currently disabled on Linux due to problems with correct DPI scaling over remote systems.

To enable scaling on Linux, use the `QT_SCREEN_SCALE_FACTORS` environment variable. +
For example, on a dual monitor system: `QT_SCREEN_SCALE_FACTORS=2.0;2.0`.
