{
   ...
   "title": "Mocha Pro 2020.5 v7.5.0 Release Notes"
}
= Mocha(R) Pro 2020.5 v7.5.0 Release Notes

:Author:    (C) Boris FX/Imagineer Systems Ltd.
:Email:     support@borisfx.com
:Date:      21/04/2020
:Revision:  2020.5 v7.5.0
:icons:		font
...
== Fixed issues since Mocha Pro 2020 v7.0.4

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10518 Relinking to footage with a different aspect ratio breaks tracked contours
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Standalone
| *Bug Description:* | Relinking to footage with a different aspect ratio broke tracked contours.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10459 Mocha's Python Installation is Incorrect on macOS
| *Platform:* | macOS
| *Product:* | Mocha Pro Standalone
| *Bug Description:* | The installation process for Mocha's Python modules did not produce valid results.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10458 Mocha's Python Installation Throws a Warning on macOS
| *Platform:* | macOS
| *Product:* | Mocha Pro Standalone
| *Bug Description:* | Mocha's Python Installation would throw warnings on macOS.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10448 Changing the Area Brush radius with the ']' key stops working with some brush radius/footage size combinations
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Brush radius keys would stop increasing the brush size with some footage.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10445 HitFilm V14 on Mac hangs when attempting to export with Mocha apply mask
| *Platform:* | macOS
| *Product:* | Mocha OFX Plug-in
| *Bug Description:* | Exporting a render in HitFilm would hang if Mocha "Apply Matte" was used.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10435	On Mac, the "Launch Mocha" button icon is not loaded if the Adobe Application is installed at a custom path which contains non-ASCII characters
| *Platform:* | macOS
| *Product:* | Mocha Adobe Plug-ins
| *Bug Description:* | Mocha will now load the launch image icon if Adobe software is installed on a custom path with non-ASCII characters.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10434 Mocha's Python Installation is Incorrect on Windows
| *Platform:* | Windows
| *Product:* | Mocha Pro Standalone
| *Bug Description:* | The installation process for Mocha's Python modules did not produce valid results.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10433	Mocha's Python Installation Throws a Warning on Windows
| *Platform:* | Windows
| *Product:* | Mocha Pro Standalone
| *Bug Description:* | The setup.py installation script for Mocha Pro Python is now Python 3 compliant.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10427 Turning auto software update checks off in registry before first running Mocha is ignored
| *Platform:* | Windows
| *Product:* | All Products
| *Bug Description:* | Turning off auto update checks in the registry before running Mocha for the first time ignores the registry setting.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10422 Mask keyframes can become spaced out when creating AE masks
| *Platform:* | macOS and Windows
| *Product:* | Mocha Pro Adobe Plug-in
| *Bug Description:* | Masks created in the Adobe plugin (Mocha AE or Mocha Pro) could become spaced apart incorrectly.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10420 Nuke projects with a very large frame range become offset and stretched
| *Platform:* | All Platforms
| *Product:* | All Mocha Plug-ins
| *Bug Description:* | Very large frame numbers could destroy project keyframes in a plug-in environment.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10418 Fixed frame offset default sets to zero when creating a new project
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | If you set a Fixed frame offset in preferences, it would reset to zero when you start a new project.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10416 "Library not loaded" error when trying to run Mocha Python 3.7 from command line
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Standalone
| *Bug Description:* | Mocha Pro Python would not load on command line.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10415 Occasional crash when rendering a remove with a top hold-out layer with Subtract or Transparent blend mode
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha could crash if the top layer of a project was set to "Subtract" or "Transparent" during a Remove.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10411 Mocha crashes when it tries to import 8k R3D clip
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha could crash when it tried to create a new project with some 8k RED clips.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10400 8K clips produces splines with twisted overlays when spline is outside of the viewer
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Splines now draw correctly outside the bounds of the viewer for 8K clips.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10373 Surface disappears if adjusted at the end of a track
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The Surface could disappear if it was adjusted after a long perspective track.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10338 Matte feather is rendered incorrectly when tracking goes too far past camera
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Matte feather was rendered incorrectly for spline segments adjacent to points behind camera.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10315 Surface distorts when tracking goes too far past camera
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | When tracking, especially in perspective, the track can distort too far and the surface becomes corrupted or disappears.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10310 Tracking fails when points go behind the camera
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Tracking could fail when points go behind camera if the shape was unlinked from tracking data.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9090 Inserts with alpha have dark edges
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Inserting an insert with Alpha would render the edge with a dark outline.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Manual stereo offset did not work as expected in 360 view unless you were using the Front camera.
|===
...
| *Bug Description:* | Interlaced clips were importing at half-res in height, which was causing Inserts to render out incorrectly.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10532 Mocha displaying double height when importing interlace footage with gstreamer
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Standalone
| *Bug Description:* | GStreamer shows interlaced footage incorrectly in Standalone
| *Workaround:* | None.
|===
...
| *Workaround:* | Use only one device when working in Mocha.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | If the QT_SCALE_FACTOR environment variable is set, it can also scale the Mocha GUI
| *Workaround:* | None.
|===
