{
   ...
   "title": "Mocha Pro 2020 v7.0.2 Release Notes"
}
= Mocha(R) Pro 2020 v7.0.2 Release Notes

:Author:    (C) Boris FX/Imagineer Systems Ltd.
:Email:     support@borisfx.com
:Date:      22/10/2019
:Revision:  2020 v7.0.2
:icons:		font
...
This is a maintenance release to support Silhouette 2020 along with several defect fixes.
...
== Fixed issues since Mocha Pro 2020 v7.0.1

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10335 Crash when accessing dropdown after closing Viewer Preferences window on Mac
| *Platform:* | macOS
| *Product:* | All Plugins
| *Bug Description:* | Mocha no longer crashes if you interact with mocha drop downs after opening the Viewer Preferences.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10316 Mediaioserver is not running on Mac plugins
| *Platform:* | macOS
| *Product:* | All Plugins
| *Bug Description:* | The process used to read clips on Mac was not running, so only image sequences could be imported from disk.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10302 Remove with CPU and GPU is slow compared to 2019.5
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha Remove was rendering much slower than expected due to reading source alpha.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10279 Silhouette hangs when opening a project that has Mocha OFX "View Matte" turned on.
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Silhouette could hang when "View Matte" was on in the Mocha Pro node.
|===
...
| *Bug Description:* | "Import shapes" in the file menu is now working correctly.
|===
...
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Mocha may flash between the default colorspace and the current Nuke colourspace when first opening the GUI.
...
| *Platform:* | Windows
| *Product:* | All Products
| *Bug Description:* | Setting Mocha's internal Fullscreen mode in preferences can disable menu actions and dropdowns.
| *Workaround:* | Use standard system fullscreen mode.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Import matte clips are being ignored by Remove module.
| *Workaround:* | Use the layer spline matte instead.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | When tracking with the area brush tool selected, the cursor wont update.
| *Workaround:* | Stop the track to move the cursor.
|===
...
- *Mac:* macOS X 10.12, 10.13 or 10.14, on 64-bit Intel.
- *Windows:* Windows 7, Windows 8 and Windows 10 on x64.
- *Linux:* Red Hat Enterprise Linux 7, CentOS 7, or a compatible distribution on x86_64.
...
- *Windows:* Windows 7, Windows 8 and Windows 10 on x64.
- *Linux:* Red Hat Enterprise Linux 7, CentOS 7, or a compatible Linux distribution on x86_64.
