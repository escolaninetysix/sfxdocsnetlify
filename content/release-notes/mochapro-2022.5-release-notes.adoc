{
  "date": "2022-04-19T00:00:00-04:00",
   ...
   "title": "Mocha Pro 2022 v9.5.0 Release Notes"
}
:skip-front-matter:
:Author:    (C) Boris FX, Inc.
:Email:     support@borisfx.com
:Date:      19/04/2022
:Revision:  2022.5 v9.5.0
:icons:		font
:toc:
:showtitle:
...
== New features in Mocha Pro 2022.5
...
== Fixed issues since v9.0.3

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11653 When a control point has animated activeness the generated Adobe After Effects Mask Data crashes After Effects
| *Platform:* | macOS and Windows
| *Product:* | Mocha Pro Adobe Plug-In
| *Bug Description:* | When a control point had animated activeness, the generated Adobe After Effects Mask Data could crash After Effects
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11652 Mocha crashes when exporting to some shape formats if a control point is initially inactive and then becomes active
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha could crash when exporting a shape if there was animated active status on a control point.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11651 Exported Silhouette Shapes do not take disabled control points into account
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Exported Silhouette Shapes did not take disabled control points into account.
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11649 Insert renders are broken when rendering across a 360 seam
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha now renders Inserts correctly when rendering across the seam.
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11639 Rendering Insert crashes Mocha after adjusting Source ROI fields
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Insert rendering no longer crashes when adjusting ROI
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11620 Insert:Cutout shows black outlines for inserts with alpha
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Fixed edge issues with insert module.
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11591 The After Effects composition Start Frame is not applied on Mac
| *Platform:* | macOS
| *Product:* | All Products
| *Bug Description:* | The After Effects composition Start Frame was not applied to Mocha on Mac
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11583 Non-hero stereo keyframes are incorrectly added when adjusting hero keyframes
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Stereo keyframes are now set correctly when adjusting the hero eye
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11571 360 Stereo Removes using clean plates can show a small black line at the seam and nadir
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | 360 Remove renders using clean plates no longer get a black line at the zenith or nadir
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11566 Splines and Overlays are not adjustable in 360 mode
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Splines and Overlays are now adjustable in 360 mode
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11544 Rendering an Insert with an RGB Insert Image produces dark lines at the edges of the inserted image
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Rendering an Insert with an RGB Insert Image produces dark lines at the edges of the inserted image
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11534 Layers named with the same name as a clip are not getting loaded appropriately
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Layers named with the same name as a clip are now getting loaded correctly.
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11530 X-Splines with corner points can generate curved corners when using "Paste Mocha Mask" in AE
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | X-Splines with corner points now generate correct corners when using "Paste Mocha Mask" in AE
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11527 Deleting an X-spline layer while still in drawing mode causes a crash
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Deleting splines while in drawing mode no longer crashes Mocha.
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11520 Regenerating meshes never clears previous mesh data from project memory
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Regenerating meshes now clears previous mesh data from project memory
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11508 Zoom window does not mirror viewer brightness changes
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Zoom window now mirrors viewer brightness changes
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11501  In the Lens Module changing lens distortion model creates unwanted lens parameter key-frames
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Changing the lens calibration dropdown no longer keyframes the calibration
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11490 Linked layers do not export with correct data to Silhouette
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Layers using "link to track" did not export correctly to Silhouette.
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11468 Clips in Mocha with alpha channel have unwanted an pixel column on the border of insert image.
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Clips with alpha channels now look correct in the Insert module.
|===

[frame="sides", stripes="odd", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11464 16-bit RGBA TIF clean plates created by Mocha don't load into Photoshop
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | 16-bit RGBA TIF clean plates now correctly load into Adobe Photoshop
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha now displays the correct error if the PowerMesh is distorted too far.
|===
...
| *Bug Description:* | Exporting to Fusion shapes will not export the correct frame offset.
| *Workaround:* | Paste the shape node then move the keyframes manually in the Fusion dopesheet.
|===
...
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-In
| *Bug Description:* | Resolve will not send the Mocha Plug-In the correct frame range in the Edit or Color pages.
| *Workaround:* | Blackmagic Design are working on a fix for this problem. Use the Fusion page when working with the Mocha OFX Plug-In in Resolve.
|===
