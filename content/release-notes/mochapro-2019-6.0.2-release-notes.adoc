{
   ...
   "description": "Mocha Pro 2019 (6.0.2) release notes",
   ...
   "title": "Mocha Pro 2019 v6.0.2 - Release Notes"
}
= Mocha(R) Pro 2019 v6.0.2 Release Notes

:Author:    (C) Boris FX/Imagineer Systems Ltd.
:Email:     support@borisfx.com
:Date:      28/02/2019
:Revision:  2019 v6.0.2
:icons: font
...
== Fixed issues since Mocha Pro 2019 6.0.1

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9809 In Hitfilm Pro 12, tracking results in the Hitfilm GUI going black and then a crash
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Fixed a crash when using Mocha Pro in HitFilm 12 after pre-rendering
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9805 Mocha can temporarily check out an interactive license even when running in headless render mode
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha will now check out interactive licenses only when required.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9796 Camera Solve Documentation is Incorrect
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Updated Camera Solve chapter to correcly describe solve and export procedure.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9790 Keyword mapping for "mocha.run_mocha()" example is incorrect in Python User Guide
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Standalone
| *Bug Description:* | Python guide now has correct example for mocha.run_mocha()
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9785 Typo in BezierControlPointData example in user guide
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Standalone
| *Bug Description:* | Python guide now has correct example for Bezier Guide
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9766 Cannot load project with mocha plugin or add mocha instance if floating license has wrong server
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Projects will now load if a floating license client cannot connect. There may still be a delay.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9757 Errors in the floating license installation instructions
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Floating license instructions are now correct.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9749 GPU is failing on 8K stereo footage
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha now manages memory on very large footage when rendering Remove with GPU acceleration.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9729 Mocha UI doesn't reset to monitor that has the host when 2nd monitor is unplugged
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Plug-ins
| *Bug Description:* | The Mocha UI now restores to default monitor if one monitor is unplugged.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9727 GPU Tracking fails for image with odd width and 'min % pixel usage' above 90
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Images with odd image widths now track correctly with the GPU tracker.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9719 Insert rendering produces an empty alpha for certain combinations of input clip and insert clip resolutions
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Insert Renders no longer fail at certain clip resolutions.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9706 Zoom windows zoom in too far when using linearized workflow
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Plug-in
| *Bug Description:* | If you use a linear workspace in the host, the Mocha plugin now handles zoom windows correctly.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9686 Plugin host renders incorrectly when stabilize is limited to a in/out range
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Plug-in
| *Bug Description:* | Stabilize now renders correctly in the host when the project range is restricted inside Mocha.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9672 Cog button UI does not update when undo/redo
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Undo now refreshes the GUI correctly to update cog interface changes.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Clips that are not 8-bit greyscale will now correctly convert to matte clips when imported
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | "Selected mattes" and "Selected track mattes" now correctly display.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The magnetic tools now generate a matte clip immediately upon creation
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The GPU remove now recovers if it runs out of memory trying to find good data in long or very large shots.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Attempting to pick a colour outside the colour dialog now works as expected.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | If you end one background layer range and start a new one you can now reference the earlier clean plate
|===
