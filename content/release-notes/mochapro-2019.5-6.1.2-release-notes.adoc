{
   ...
   "description": "Mocha Pro 2019.5 (6.1.2) release notes",
   ...
   "title": "Mocha Pro 2019.5 v6.1.2 - Release Notes"
}
= Mocha(R) Pro 2019.5 v6.1.2 Release Notes

:Author:    (C) Boris FX/Imagineer Systems Ltd.
:Email:     support@borisfx.com
:Date:      12/08/2019
:Revision:  2019.5 v6.1.2
:icons: font
...
This is a minor maintenance release to add HASP dongle support and correct some defects.
...
== Fixed issues since Mocha Pro 2019 6.1.1

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10028 Mocha OFX receiving empty (black) frames in Vegas
| *Platform:* | Windows
| *Product:* | Mocha Pro OFX Plug-In
| *Bug Description:* | Mocha could sometimes get black frames when used inside Vegas.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10013 Projects created in standalone are having their offset doubled in the plugin
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | A project created in Mocha Pro standalone would have its offset doubled when opened in the plugin.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10010 Avid crashes when rendering back to host with Mocha Stabilize and Autofill
| *Platform:* | macOS and Windows
| *Product:* | Mocha Pro AVX Plug-In
| *Bug Description:* | Media Composer no longer crashes if rendering with autofill in the Mocha Stabilize module
|===
