{
   ...
   "title": "Mocha Pro 2020 v7.0.0 Release Notes"
}

= Mocha(R) Pro 2020 v7.0.0 Release Notes

:Author:    (C) Boris FX/Imagineer Systems Ltd.
:Email:     support@borisfx.com
:Date:      20/09/2019
:Revision:  2020 v7.0.0
:icons:		font
...
This is a major release with several new features and defect fixes.
...
== Fixed issues since Mocha Pro 2019.5 6.1.2

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10170 Nuke projects saved in v6.1.1 break frame offset in later versions
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-In
| *Bug Description:* | Nuke projects using Mocha Pro 2019.5 v6.1.1 or earlier no longer have incorrect key offsets in the saved file.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10160 Mocha becomes watermarked after rendering long projects without mocha being used in the middle
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Plug-ins
| *Bug Description:* | Mocha Pro could become unlicensed if the plugin was used intermittently during a long host render.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10145	Motion blur renders left view in right view mattes
| *Platform:* | All Platforms
| *Product:* | All products
| *Bug Description:* | Mocha now correctly renders the right view when using motion blur in stereo mattes.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10037 The Surface center point interferes with Mesh warp points
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The surface center point no longer takes priority when the mesh warp is in focus.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-9237 Mocha Python throws a Segmentation fault 11 if a Project is passed a NoneType
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Standalone
| *Bug Description:* | Mocha Python no longer crashes if it gets passed a Project value of None.
|===
...
| *Platform:* | Windows
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Vegas 17 will crash when rendering in the Mocha GUI if Deprecated QuickTime support is not enabled in Vegas preferences.
| *Workaround:* | Turn QuickTime support on in Vegas preferences and restart Vegas.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10210	Erase paint area mode can sometimes create a spline when Quick Mask is not selected
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Area Brush erase mode (alt) can sometimes cause an additive spline rather than a subtraction.
| *Workaround:* | None.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | After creating a spline with Area Brush, the spline appears deselected.
| *Workaround:* | Deselect and reselect the layer.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The zoom window currently cannot be moved manually.
| *Workaround:* | None.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Tracking with a very large frame offset can cause a crash
| *Workaround:* | Change the frame offset to a smaller value.
|===
...
* *Mocha Plug-in for OFX:* Autodesk Flame 2020 or higher. The Foundry Nuke 8 or higher. Fusion Studio 8 or higher. HitFilm Pro 2017 or higher. Silhouette 6 or higher. Vegas Pro 14 or higher.
