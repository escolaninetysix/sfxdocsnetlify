...
== New features in Mocha Pro 2021 v8.0.2

Aside from general performance improvements, there are no new features in v8.0.2.
...
== Fixed issues since Mocha Pro 2021 v8.0.1

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11055 Crash starting Mocha on Windows if the Username contains non-ASCII characters
| *Platform:* | Windows
| *Product:* | All Products
| *Bug Description:* | User accounts with non-ASCII characters would crash Mocha due to an init.py path error.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11054 Crash when loading R3D footage and the OCIO Colorspace settings require a colorspace conversion
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | If the working color space needed to be changed on an R3D clip imported into the project, Mocha would crash.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11035 Mocha reloads all cached "Original Clip" images
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Mocha now doesn't try to re-cache "Original Clip" images when "Cache Original Clip" is enabled, if the clip was already cached.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11032 Track Mesh picking can cause a Standard Library Error
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The tracking mesh could throw an error when picking vertices.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11029 GStreamer is not reading the right frames of footage
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Standalone
| *Bug Description:* | Mocha Standalone was incorrectly reading clip frames for some footage when using GStreamer as the video input method.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11026 Mocha plugin degrades 10bit images when rendering in Avid
| *Platform:* | macOS and Windows
| *Product:* | Mocha Pro AVX Plug-in
| *Bug Description:* | When Media Composer video quality mode is 10 bit, Mocha no longer reverts to rendering at 8 bits.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11020 Mocha shows buffer error trying to save mesh project with low resolution footage
| *Platform:* | All Platforms
| *Product:* | All Mocha Pro Plug-ins
| *Bug Description:* | Mocha would show a buffer error trying to save mesh projects with low resolution footage.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11018 Frame offset does not include clip trim in After Effects when viewing frames in Host Format
| *Platform:* | macOS and Windows
| *Product:* | Mocha Pro Adobe Plug-in
| *Bug Description:* | After Effects Compositions that are trimmed at the head showed no trim when viewing the timeline frames in Host Format.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11015 Cutting a clip in two in Premiere or modifying the Layer Properties in standalone will cause Mesh Warp/Unwarp to fail
| *Platform:* | macOS and Windows
| *Product:* | Mocha Pro Adobe Plug-in
| *Bug Description:* | Warp Rendering is now correct when splitting a Premiere clip that has a Mocha effect applied.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* |  MO-11014 Still images are not read as individual frames in Fusion on render to host
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Still images placed on the node graph in Fusion are now being read as having frames when rendering modules such as Stabilize Warp.
|===
...
| *Platform:* | All Platforms
| *Product:* | Mocha Pro Adobe Plug-In
| *Bug Description:* | Still images that are used across more than one frame were being treated as single frames when rendering to the Premiere timeline.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-11013 Stabilize "Fixed Frames" add button can only set 1 frame
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | "Fixed frames" can now set more than one frame in Stabilize mode when clicking the + button.
|===
...
| *Platform:* | All Platforms
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | Mocha effects applied to Fusion nodes that have frame ranges, such as text, will now correctly register a render back in the host.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | The "Add vertex" option now works for all mesh edges.
|===
...
| *Platform:* | macOS
| *Product:* | All Products
| *Bug Description:* | Mocha no longer crashes when deactivating a license on macOS Big Sur.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10906 Welcome Screen prevents Mocha from quitting on Mac
| *Platform:* | macOS
| *Product:* | All Products
| *Bug Description:* | Not closing the welcome screen would leave Mocha open if you tried to close the main window.
|===

[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | MO-10901 Flame 2021 hang on Mac when launching Mocha UI
| *Platform:* | macOS
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | In some cases when opening Mocha on Flame 2021, the software could hang.
|===
...
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | On some hardware, Mocha users were experiencing a blacked-out GUI while working.
|===
...
| *Platform:* | macOS
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | GPU Remove would not render to the timeline on macOS Flame.
|===
...
| *Platform:* | Linux
| *Product:* | Mocha Pro OFX Plug-in
| *Bug Description:* | You can now render on headless render farms with Nuke projects containing Mocha OFX Plug-ins.
|===
...
| *Platform:* | macOS and Windows
| *Product:* | Mocha Pro Adobe Plug-in
| *Bug Description:*| Splitting up a clip in Premiere that has the Mocha Pro Effect applied would not render the clip until you relaunched the Mocha GUI to update the effect.
|===
...
[frame="top", grid="cols", cols="1,3", width="100%"]
|===
| *Issue:* | Bug MO-11038 Exporting Power Mesh Shapes to Silhouette Not Baked
| *Platform:* | All Platforms
| *Product:* | All Products
| *Bug Description:* | Silhouette shape exports from Mocha do not bake in the spline warping keyframes
| *Workaround:* | None.
|===
