...
* Mesh (Mocha Pro Only): Movement within the overall plane, such as distortion, warp etc. See <<powermesh,PowerMesh and Mesh Tracking>> in the next chapter for more information on this tracking method.
...
* Existing Planar Data: This is only used when you want to add Mesh tracking to an existing planar track. See <<powermesh,PowerMesh and Mesh Tracking>> in the next chapter for more information on this tracking method.
...
image::UserGuide/en_US/images/ShowSurface_2x.jpg[]
