...
* Mesh: Movement within the overall plane, such as distortion, warp etc.
...
image:UserGuide/en_US/images/powermesh_tracking_001.jpg[width="40%"]
...
image:UserGuide/en_US/images/powermesh_tracking_002.jpg[width="40%"]

An initial Mesh is generated.

image:UserGuide/en_US/images/powermesh_tracking_003.jpg[width="40%"]

Then you can refine your PowerMesh with the following parameters.

image:UserGuide/en_US/images/powermesh_generation_column.jpg[width="40%"]
...
image:UserGuide/en_US/images/powermesh_tracking_column.jpg[width="40%"]
