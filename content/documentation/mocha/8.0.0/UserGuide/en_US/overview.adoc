...
image:UserGuide/en_US/images/main-overview.png[]
...
| image:UserGuide/en_US/images/MagneticShapeToolXSpline_2x.jpg[]|*Create New Magnetic Layer:* Draw a magnetic line that converts to an X-Spline.
| image:UserGuide/en_US/images/MagneticShapeToolAddXSpline_2x.jpg[]|*Add Magnetic Shape Selected to Layer:* Add a new magnetic line that converts to an X-Spline in the existing layer.
| image:UserGuide/en_US/images/FreehandShapeToolXSpline_2x.jpg[]|*Create New Freehand Layer:* Draw a freehand line that converts to an X-Spline.
| image:UserGuide/en_US/images/FreehandShapeToolAddXSpline_2x.jpg[]|*Add Freehand Shape Selected to Layer:* Add a new freehand line that converts to an X-Spline in the existing layer.
| image:UserGuide/en_US/images/ICON_AreaBrushToolXSpline.jpg[]|*Create Area Brush Layer:* Paint on the canvas to generate an X-Spline.
| image:UserGuide/en_US/images/ICON_AreaBrushToolAddXSpline.jpg[]|*Add Area Brush to Layer:* Paint on the canvas to add an X-Spline to an existing layer.
...
| image:UserGuide/en_US/images/ToolEditMesh.jpg[]|*EditMesh:* Toggles layer into Edit Mesh Mode for editing mesh vertices.
...
| image:UserGuide/en_US/images/ToolAddVertex.jpg[]|*Add Vertex:* Adds a vertex to a selected edge when in Edit Mesh Mode.
|====
...
| image:UserGuide/en_US/images/ICON_Proxy_001.jpg[width="40%"]|*Proxy Scale:* Adjust the resolution of the footage for performance (Mocha Standalone only)
...
| image:UserGuide/en_US/images/ICON_ViewerControls_001.jpg[]|*Viewer Preferences:* Adjustments dialog for parameters such as grid lines and trace frames. Also controls for viewer OCIO colourspaces.
|====
...
image:UserGuide/en_US/images/clear_cache_dialog.jpg[]
