...
image:UserGuide/en_US/images/5.0.0_mochapro_ae_plugin_license_control.jpg[pdfwidth="60%", width="60%"]

===== Adobe Premiere Plugin License

For Premiere, click the small icon next to the effect title:

image:UserGuide/en_US/images/5.0.0_mochapro_premiere_plugin_license_control.jpg[pdfwidth="60%", width="60%"]
...
image:UserGuide/en_US/images/5.0.0_mochapro_avid_plugin_license_control.jpg[pdfwidth="60%", width="60%"]
...
image:UserGuide/en_US/images/mochapro_OFX_plugin_license_control.jpg[pdfwidth="60%", width="60%"]
