...
image:UserGuide/en_US/images/megaplate_input.jpg[pdfwidth="40%", width="40%"]
...
image:UserGuide/en_US/images/search_range.jpg[pdfwidth="60%", width="60%"]
...
image:UserGuide/en_US/images/illumination.jpg[pdfwidth="60%", width="60%"]
