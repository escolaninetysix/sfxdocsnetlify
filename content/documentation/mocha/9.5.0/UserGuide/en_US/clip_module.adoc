...
image:UserGuide/en_US/images/clip_001.jpg[pdfwidth="80%", width="60%"]
...
image:UserGuide/en_US/images/clip_003.jpg[pdfwidth="60%", width="60%"]
...
image:UserGuide/en_US/images/clip_002.jpg[pdfwidth="60%", width="60%"]
...
image:UserGuide/en_US/images/Clip_Tab_Streams.jpg[]
...
image:UserGuide/en_US/images/clip_stream_addbutton.jpg[]

You can then choose a new footage stream to add to the current clip from the Import dialog.

image:UserGuide/en_US/images/clip_importfootagestream.jpg[]
...
+
image:UserGuide/en_US/images/clip_stream_relinkbutton.jpg[]
+
...
+
image:UserGuide/en_US/images/clip_relinkfootagestream.jpg[]
+
