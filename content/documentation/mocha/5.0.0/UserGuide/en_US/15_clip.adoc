...
image://borisfx-com-res.cloudinary.com/image/upload/v1531783954/documentation/mocha/images/5.0.0/4.0.0_Clip_Tab_Streams.jpg[]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531783954/documentation/mocha/images/5.0.0/clip_001.jpg[width="60%"]			
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531783954/documentation/mocha/images/5.0.0/clip_003.jpg[width="60%"]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531783954/documentation/mocha/images/5.0.0/clip_002.jpg[width="60%"]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531783954/documentation/mocha/images/5.0.0/clip_stream_addbutton.jpg[]

You can then choose a new footage stream to add to the current clip from the Import dialog.

image://borisfx-com-res.cloudinary.com/image/upload/v1531783954/documentation/mocha/images/5.0.0/clip_importfootagestream.jpg[]
...
+
image://borisfx-com-res.cloudinary.com/image/upload/v1531783954/documentation/mocha/images/5.0.0/clip_stream_relinkbutton.jpg[]
+
...
+
image://borisfx-com-res.cloudinary.com/image/upload/v1531783954/documentation/mocha/images/5.0.0/clip_relinkfootagestream.jpg[]
+
