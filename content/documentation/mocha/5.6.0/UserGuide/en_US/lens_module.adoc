...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lenstabfull.jpg[]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lens_input.jpg[]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lens_distortion_map.jpg[]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/calibration.jpg[]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lens_locatelinesscreen.jpg[]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/Simplegrid_1_param.jpg[]

Here is an example grid of a 2-Parameter distortion model:

image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/Simplegrid_2_param.jpg[]

Here is an example grid of an anamorphic distortion model:

image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/Simplegrid_anamorphic.jpg[]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lens_calibratedscreen.jpg[]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lensdistortion.jpg[]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/LENS_equidistantlines.jpg[]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lens_distortion_map_example.jpg[]
...
+
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lens_distortion_map_calibration.jpg[]
+
. To check the distortion, turn on your grid
...
+
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lens_exportlensdata_ae.jpg[]
+
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lens_pastelensdata_ae.jpg[]
...
+
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lens_distortion_map_export_01.jpg[]
+
. Note that:
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lens_exporttrackingdata_ae.jpg[]
...
+
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lens_cornerpinpaste_ae.jpg[]
+
...
+
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lens_distortprecomp_ae.jpg[]
...
+
image://borisfx-com-res.cloudinary.com/image/upload/v1531784263/documentation/mocha/images/5.6.0/lens_applydistortionplugin_ae.jpg[]
