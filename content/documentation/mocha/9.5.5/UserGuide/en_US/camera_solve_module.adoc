...
image:UserGuide/en_US/images/Stereo_Export_Camera_Data.jpg[pdfwidth="60%", width="60%"]
...
+
image:UserGuide/en_US/images/EXPORT_CameraSolve.jpg[pdfwidth="60%", width="60%"]
+
