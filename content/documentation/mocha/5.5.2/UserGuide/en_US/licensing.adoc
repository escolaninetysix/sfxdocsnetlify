...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784130/documentation/mocha/images/5.5.2/5.0.0_mochapro_activation_welcome_screen.jpg[width="60%"]
. Fill out the registration details on the main page
image://borisfx-com-res.cloudinary.com/image/upload/v1531784130/documentation/mocha/images/5.5.2/5.0.0_mochapro_license_serial_dialog_page_01.jpg[width="60%"]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784130/documentation/mocha/images/5.5.2/5.0.0_mochapro_license_serial_dialog_page_02.jpg[width="60%"]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784130/documentation/mocha/images/5.5.2/5.0.0_mochapro_license_serial_alternate_activation.jpg[width="60%"]
. Your license should install automatically and mocha will close.
. Reopen mocha to start using your licensed version!
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784130/documentation/mocha/images/5.5.2/5.0.0_mochapro_ae_plugin_license_control.jpg[width="60%"]

===== Adobe Premiere Plugin License

For Premiere, click the small icon next to the effect title:
image://borisfx-com-res.cloudinary.com/image/upload/v1531784130/documentation/mocha/images/5.5.2/5.0.0_mochapro_premiere_plugin_license_control.jpg[width="60%"]
...
image://borisfx-com-res.cloudinary.com/image/upload/v1531784130/documentation/mocha/images/5.5.2/5.0.0_mochapro_avid_plugin_license_control.jpg[width="60%"]
...
. If all else fails, our support team is happy to help you figure this out. Please follow the link: https://borisfx.com/support/open-a-case/[contact support]!
