{
"date": "2019-06-12",
"title": "BCC Criss-Cross Wipe",
"category": "BCC Transitions",
"link": "bcc-criss-cross-wipe/"
}

 **Overview**


The Criss-Cross Wipe combines two independent Multi-Stripe filters, to make wipes in a variety of patterns. At the default value, this wipe appears similar to a Grid wipe.


[![BCC_Criss_Cross_Wipe](https://borisfx-com-res.cloudinary.com/image/upload//documentation/continuum/uploads/2013/06/BCC_Criss_Cross_Wipe.jpg)](https://borisfx-com-res.cloudinary.com/image/upload//documentation/continuum/uploads/2013/06/BCC_Criss_Cross_Wipe.jpg)
...
The **Combine****menu** determines how the stripes are combined. The choices are:
...
* *Intersect* renders the opacity as the smallest opacity of the two separate wipes.When Intersect is chosen, the wipe may reach remain at full transparency at a **Percent** **Done** value significantly above 0.
...
|  |  |
| --- | --- |
| [![wipes.ccross.intersect](https://borisfx-com-res.cloudinary.com/image/upload//documentation/continuum/uploads/2013/06/wipes.ccross.intersect.jpg)](https://borisfx-com-res.cloudinary.com/image/upload//documentation/continuum/uploads/2013/06/wipes.ccross.intersect.jpg) | [![wipes.ccross.union](https://borisfx-com-res.cloudinary.com/image/upload//documentation/continuum/uploads/2013/06/wipes.ccross.union_.jpg)](https://borisfx-com-res.cloudinary.com/image/upload//documentation/continuum/uploads/2013/06/wipes.ccross.union_.jpg) |
| Intersect | Union |
...
|  |  |
| --- | --- |
| [![wipes.ccross.stripes1](https://borisfx-com-res.cloudinary.com/image/upload//documentation/continuum/uploads/2013/06/wipes.ccross.stripes1.jpg)](https://borisfx-com-res.cloudinary.com/image/upload//documentation/continuum/uploads/2013/06/wipes.ccross.stripes1.jpg) | [![wipes.ccross.stripes2](https://borisfx-com-res.cloudinary.com/image/upload//documentation/continuum/uploads/2013/06/wipes.ccross.stripes2.jpg)](https://borisfx-com-res.cloudinary.com/image/upload//documentation/continuum/uploads/2013/06/wipes.ccross.stripes2.jpg) |
| Stripes 1 | Stripes 2 |


**Relative** **Angle** sets the angle that the two sets of stripes make with each other. The default value is 90 degrees.


**Relative** **Rotation** **Rate** lets you auto-rotate the Relative Angle parameter.
...
**Master** **Separation** scales the separation controls found in each Stripe parameter group. This parameter has no affect if the **Fit Stripes to Image checkbox** is selected.


If the **Fit Stripes to Image checkbox** is selected, the filter automatically determines the Separation Width for each group of stripes using the Angle and Stripe Count parameters. As a result, the stripes are centered in the image as long as the Wipe Center parameter remains at the image center. When this checkbox is selected, the Master Width and the Width parameters have no affect.


**Stripe Count 1** and **Stripe Count 2** set the number of horizontal and vertical stripes.


 


**Stripes 1 and Stripes 2 Parameter Groups**


When the Combine menu is set to Union or Intersected, both parameter groups apply. When the Combine menu is set to Stripes 1, only the Stripes 1 parameters apply. When the Combine menu is set to Stripes 2, only the Stripes 2 parameters apply.


**Stripe** **Width** sets the size of the corresponding stripes. This parameter has no affect if the Animation menu is set to Auto.
...
**Manual Separation** allows you to manually set the space between the corresponding stripes. If the **Fit Stripes to Image checkbox** is selected, these parameters have no affect.
