{
"date": "2019-06-12",
"title": "BCC Ribbon Wipe",
"category": "BCC Transitions",
"link": "bcc-ribbon-wipe/"
}

 ### Overview


Ribbon Wipe transitions between two layers by animating parallel stripes or ribbons of transparency which progressively reveal the underlying layer as the thickness of the transparent stripes increases.


[![BCC_Ribbon_Wipe](https://borisfx-com-res.cloudinary.com/image/upload//documentation/continuum/uploads/2013/10/BCC_Ribbon_Wipe.jpg)](https://borisfx-com-res.cloudinary.com/image/upload//documentation/continuum/uploads/2013/10/BCC_Ribbon_Wipe.jpg)
...
**Ribbon Count**controls the number of ribbons into which the image is divided.  Higher values produce thinner individual ribbons and lower values produce thicker ribbons.


**Direction** rotates the angle of the ribbon layout.


**Softness** softens the edges of the wipe by increasing transparency in pixels that are close to the edges.


**Ribbon Offset** shifts the position of the ribbons in the direction perpendicular to which they are aligned.
